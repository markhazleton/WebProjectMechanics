<%@ WebHandler Language="VB" Class="TwitterSearchRSS" %>
...
Public Class TwitterSearchRSS : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim uri As New Uri(wpm_RemoveHtml(String.Format("http://search.twitter.com/search.rss?lang=en&q={0}+filter%3Alinks&rpp=5", SearchKeyword)))
