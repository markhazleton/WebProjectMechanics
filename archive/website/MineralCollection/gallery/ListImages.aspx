<%@ Page Language="VB" MasterPageFile="~/MineralCollection/MineralAdmin.master" CodeFile="ListImages.aspx.vb" Inherits="MineralCollection_ListImages" %>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-sm=4 col-xs-12">
            <div class="form-group">
                <asp:LinkButton ID="cmd_FileUpload" runat="server" CssClass="btn btn-primary" PostBackUrl="~/MineralCollection/gallery/Default.aspx" Text="Upload Image Files"></asp:LinkButton>
            </div>
