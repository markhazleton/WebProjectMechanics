Public Class AdminPage
    ...
    Public Const STR_ImageFolder As String = "image/"
    ...
    Public Function LoadMenu() As List(Of LookupItem)
        ...
        myListItems.Add(New LookupItem With {.Value = "/admin/maint/default.aspx?type=SiteCategoryGroup", .Name = "Location Group"})
