...
Public Class ArticleList
    ...
    Sub New(ByRef myActiveCompany As ActiveCompany)
        ...
        Dim BlogPage = (From i In myActiveCompany.LocationList Where i.LocationID = curLocationID Select i).SingleOrDefault

        Me.Clear()
        For Each myArticle In ((From i In myActiveCompany.ArticleList Where i.ArticlePageID = curLocationID Order By i.ArticleModDate Descending).ToArray)
            myArticle.PageName = BlogPage.LocationName
            myArticle.RowsPerPage = BlogPage.RowsPerPage
            myArticle.ArticlePageID = BlogPage.LocationID
            Me.Add(myArticle)
        Next
