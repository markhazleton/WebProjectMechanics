<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ParameterType.ascx.vb" Inherits="admin_maint_ParameterType" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 form-group">
                            <asp:Label ID="LabeltbParameterTypeNM" runat="server" CssClass="form-control" AssociatedControlID="tbParameterTypeNM" Text="Name"></asp:Label>
                            <asp:TextBox ID="tbParameterTypeNM" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <asp:Label ID="LabeltbParameterTypeDS" runat="server" CssClass="form-control" AssociatedControlID="tbParameterTypeDS" Text="Description"></asp:Label>
                            <asp:TextBox ID="tbParameterTypeDS" runat="server" CssClass="form-control" Rows="3" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <asp:Label ID="LabeltbParameterTemplate" runat="server" CssClass="form-control" AssociatedControlID="tbParameterTemplate" Text="Template"></asp:Label>
                            <asp:TextBox ID="tbParameterTemplate" runat="server" CssClass="form-control" Rows="5" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group">
