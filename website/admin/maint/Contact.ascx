                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            ...
                            <label>First Name:<asp:TextBox ID="FirstNameTextBox" runat="server" CssClass="form-control"></asp:TextBox></label>
                            <label>Last Name:<asp:TextBox ID="LastNameTextBox" runat="server" CssClass="form-control"></asp:TextBox></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <label>Active:<asp:CheckBox ID="ActiveCheckBox" runat="server" CssClass="form-control" /></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group">
