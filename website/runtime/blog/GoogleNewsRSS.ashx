<%@ WebHandler Language="VB" Class="GoogleNewsRSS" %>
...
Public Class GoogleNewsRSS : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim uri As New Uri(wpm_RemoveHtml(String.Format("http://news.google.com/news?pz=1&cf=all&ned=us&hl=en&q={0}&cf=all&output=rss", SearchKeyword)))
