<%@ WebHandler Language="VB" Class="GoogleVideoRSS" %>
...
Public Class GoogleVideoRSS : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim uri As New Uri(wpm_RemoveHtml(String.Format("http://video.google.com/videosearch?q={0}&hl=Den&output=rss", SearchKeyword)))
