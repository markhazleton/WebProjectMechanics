...
Partial Class mhweb_login_login
    Inherits mhPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("msg") = ""
        If IsPostBack Then
            If mhUser.ProcessLogin(GetProperty("Username", ""), GetProperty("Password", ""), mySession) Then
                'We are logged In
                If (mhSession.GetLogin_Link() = "") Then
                    Response.Redirect("/")
                Else
                    Response.Redirect(mhSession.GetLogin_Link())
                End If
            Else
                ...
                ' **************************************************************************
                mhSession.SetContactID("")
                mhSession.SetUserName("")
                mhSession.SetUserGroup("4")
            End If
        End If
