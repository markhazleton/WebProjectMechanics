  ...
  <Q:template match="/">
    ...
    <dl class="Items">
      ...
      <Q:for-each select="/rss/channel/item">
        ...
        <Q:if test="author">
          <dd name="decodeme">Post by  
            <Q:value-of disable-output-escaping="yes" select="author"/>
          </dd>
        </Q:if>
      </Q:for-each>
    </dl>
