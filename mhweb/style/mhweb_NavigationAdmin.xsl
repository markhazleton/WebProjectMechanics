      ...
      <xsl:for-each select="mhSiteFile/SiteMapRows/mhSiteMapRow">
        ...
        <tr>
          ...
          <td class="left" style="white-space: nowrap;">
            ...
            <xsl:for-each select="BreadCrumbRows/mhBreadCrumbRow">
          ...
          <td class="left">
            ...
            <xsl:if test="RecordSource='Article'">
              <a>
                <xsl:attribute name="href">/aspmaker/article_edit.aspx?ArticleID=<xsl:value-of select="ArticleID"/></xsl:attribute>
                <xsl:value-of select="PageName"/>
              </a>
            </xsl:if>
            <xsl:if test="RecordSource='Image'">
              <a>
                <xsl:attribute name="href">/aspmaker/image_edit.aspx?ImageID=<xsl:value-of select="ArticleID"/></xsl:attribute>
                <xsl:value-of select="PageName"/>
              </a>
            </xsl:if>
          </td>
