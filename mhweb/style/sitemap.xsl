  ...
  <xsl:template name="sitemapTable">
    ...
    <table border="1" width="100%" class="ewTable" id="table0">
	  <tr class="ewTableHeader">
            ...
            <td nowrap="nowrap">Page Keywords</td>
  ...
  <xsl:template match="sitemap:url">
    <tr class="ewTableRow">  
      <td nowrap="nowrap" class="ewTableRow"><xsl:variable name="sitemapURL"><xsl:value-of select="sitemap:loc"/></xsl:variable>  
        <a href="{$sitemapURL}" target="_blank" ref="nofollow"><xsl:value-of select="sitemap:PageName"></xsl:value-of></a></td>
      <td nowrap="nowrap" class="ewTableRow"><xsl:value-of select="sitemap:PageKeywords"/></td>
