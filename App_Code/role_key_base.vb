...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class rolekey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				RoleID = Convert.ToInt32(values(0))
			End If
		...
		Public Overridable Property RoleID As Int32
			Get 
				return _RoleID
			End Get
			Set 
		...
		Public Overloads Function Equals(ByVal obj As rolekey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.RoleID = obj.RoleID) AndAlso isEquals)
			Return isEquals
		End Function
