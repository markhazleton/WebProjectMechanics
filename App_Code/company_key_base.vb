...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class Companykey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				CompanyID = Convert.ToInt32(values(0))
			End If
		...
		Public Overloads Function Equals(ByVal obj As Companykey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.CompanyID = obj.CompanyID) AndAlso isEquals)
			Return isEquals
		End Function
