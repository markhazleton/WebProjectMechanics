...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class PageRolerow_base
		...
		Public Function GetKey() As PageRolekey
			Dim key As PageRolekey = New PageRolekey()
			key.PageRoleID = CType(Me.PageRoleID,Int32) 
			Return key
		End Function
		...
		Public Sub New()
			Add("PageRoleID", GetType(Nullable(Of Int32))) ' PageRoleID Attribute
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As PageRolerow = (DirectCast(obj, PageRolerow))
		...
		''' <summary>
		''' PageRoleID Attribute
		''' </summary>

		Public Overridable Property PageRoleID As Nullable(Of Int32)
			Get 
				Return DirectCast(_Fields("PageRoleID"), Nullable(Of Int32))
			End Get
			Set 
				_Fields("PageRoleID") = value
			End Set
		End Property
