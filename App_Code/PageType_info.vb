...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cPageType
		...
		Public ReadOnly Property PageTypeID() As cField
			Get
				If m_PageTypeID Is Nothing Then m_PageTypeID = New cField("PageType", "x_PageTypeID", "PageTypeID", "[PageTypeID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_PageTypeID
			End Get
		End Property
		...
		Public ReadOnly Property PageTypeCD() As cField
			Get
				If m_PageTypeCD Is Nothing Then m_PageTypeCD = New cField("PageType", "x_PageTypeCD", "PageTypeCD", "[PageTypeCD]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_PageTypeCD
			End Get
		End Property
		...
		Public ReadOnly Property PageTypeDesc() As cField
			Get
				If m_PageTypeDesc Is Nothing Then m_PageTypeDesc = New cField("PageType", "x_PageTypeDesc", "PageTypeDesc", "[PageTypeDesc]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property PageFileName() As cField
			Get
				If m_PageFileName Is Nothing Then m_PageFileName = New cField("PageType", "x_PageFileName", "PageFileName", "[PageFileName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
