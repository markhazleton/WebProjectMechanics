...
Public Partial Class AspNetMaker7_WPMGen
	...
	Public CompanySiteParameter As cCompanySiteParameter

	' Define table class
	Class cCompanySiteParameter
		...
		Public ReadOnly Property HighlightName() As String
			Get
				Return "CompanySiteParameter_Highlight"
			End Get
		End Property
		...
		Public ReadOnly Property SqlSelect() As String
			Get ' Select
				Return "SELECT * FROM [CompanySiteParameter]"
			End Get
		End Property
		...
		Public Function Insert(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "INSERT INTO [CompanySiteParameter] (" & names & ") VALUES (" & values & ")"
		...
		Public Function Update(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "UPDATE [CompanySiteParameter] SET " & values
		...
		Public Function Delete(ByRef Rs As OrderedDictionary) As Integer
			Dim Sql As String
			Dim fld As cField			
			Sql = "DELETE FROM [CompanySiteParameter] WHERE "
			fld = FieldByName("CompanySiteParameterID")
			Sql = Sql & fld.FldExpression & "=" & ew_QuotedValue(Rs("CompanySiteParameterID"), EW_DATATYPE_NUMBER) & " AND "
		...
		Private ReadOnly Property SqlKeyFilter() As String
			Get
				Return "[CompanySiteParameterID] = @CompanySiteParameterID@"
			End Get
		End Property
		...
		Public ReadOnly Property KeyFilter() As String
			Get
				...
				If Not IsNumeric(CompanySiteParameterID.CurrentValue) Then
					sKeyFilter = "0=1" ' Invalid key
				End If
				sKeyFilter = sKeyFilter.Replace("@CompanySiteParameterID@", ew_AdjustSql(CompanySiteParameterID.CurrentValue)) ' Replace key value
				Return sKeyFilter
			End Get
		End Property
		...
		Public ReadOnly Property ReturnUrl() As String
			Get ' Get referer URL automatically
				...
				Else
					Return "CompanySiteParameter_list.aspx"
				End If
			End Get
		End Property
		...
		Public Function ViewUrl() As String
			Return KeyUrl("CompanySiteParameter_view.aspx", UrlParm(""))
		End Function

		' Add URL
		Public Function AddUrl() As String
			AddUrl = "CompanySiteParameter_add.aspx"
		...
		Public Function EditUrl() As String
			Return KeyUrl("CompanySiteParameter_edit.aspx", UrlParm(""))
		End Function
		...
		Public Function CopyUrl() As String
			Return KeyUrl("CompanySiteParameter_add.aspx", UrlParm(""))
		End Function
		...
		Public Function DeleteUrl() As String
			Return KeyUrl("CompanySiteParameter_delete.aspx", UrlParm(""))
		End Function
		...
		Public Function KeyUrl(url As String, parm As String) As String
			...
			If Not IsDbNull(CompanySiteParameterID.CurrentValue) Then
				sUrl = sUrl & "CompanySiteParameterID=" & CompanySiteParameterID.CurrentValue
			Else
		...
		Public Sub LoadListRowValues(ByRef RsRow As OleDbDataReader)			
			CompanySiteParameterID.DbValue = RsRow("CompanySiteParameterID")
		...
		Public Function FieldByName(Name As String) As Object
			If Name = "CompanySiteParameterID" Then Return CompanySiteParameterID
		...
		' CompanySiteParameterID
		Private m_CompanySiteParameterID As cField

		Public ReadOnly Property CompanySiteParameterID() As cField
			Get
				If m_CompanySiteParameterID Is Nothing Then m_CompanySiteParameterID = New cField("CompanySiteParameter", "x_CompanySiteParameterID", "CompanySiteParameterID", "[CompanySiteParameterID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_CompanySiteParameterID
			End Get
		End Property
		...
		Public ReadOnly Property CompanyID() As cField
			Get
				If m_CompanyID Is Nothing Then m_CompanyID = New cField("CompanySiteParameter", "x_CompanyID", "CompanyID", "[CompanyID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_CompanyID
			End Get
		End Property
		...
		Public ReadOnly Property zPageID() As cField
			Get
				If m_zPageID Is Nothing Then m_zPageID = New cField("CompanySiteParameter", "x_zPageID", "PageID", "[PageID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_zPageID
			End Get
		End Property
		...
		Public ReadOnly Property SiteCategoryGroupID() As cField
			Get
				If m_SiteCategoryGroupID Is Nothing Then m_SiteCategoryGroupID = New cField("CompanySiteParameter", "x_SiteCategoryGroupID", "SiteCategoryGroupID", "[SiteCategoryGroupID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SiteParameterTypeID() As cField
			Get
				If m_SiteParameterTypeID Is Nothing Then m_SiteParameterTypeID = New cField("CompanySiteParameter", "x_SiteParameterTypeID", "SiteParameterTypeID", "[SiteParameterTypeID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SortOrder() As cField
			Get
				If m_SortOrder Is Nothing Then m_SortOrder = New cField("CompanySiteParameter", "x_SortOrder", "SortOrder", "[SortOrder]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_SortOrder
			End Get
		End Property
		...
		Public ReadOnly Property ParameterValue() As cField
			Get
				If m_ParameterValue Is Nothing Then m_ParameterValue = New cField("CompanySiteParameter", "x_ParameterValue", "ParameterValue", "[ParameterValue]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
		...
		Public Sub Dispose() Implements IDisposable.Dispose
			If m_CompanySiteParameterID IsNot Nothing Then m_CompanySiteParameterID.Dispose()
