...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class PageImagerow_base
		...
		Public Function GetKey() As PageImagekey
			Dim key As PageImagekey = New PageImagekey()
			key.PageImageID = CType(Me.PageImageID,Int32) 
			Return key
		End Function
		...
		Public Sub New()
			Add("PageImageID", GetType(Nullable(Of Int32))) ' PageImageID Attribute
			Add("PageID", GetType(Nullable(Of Int32))) ' PageID Attribute
			Add("ImageID", GetType(Nullable(Of Int32))) ' ImageID Attribute
			Add("PageImagePosition", GetType(Nullable(Of Int32))) ' PageImagePosition Attribute
		End Sub
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As PageImagerow = (DirectCast(obj, PageImagerow))
		...
		''' <summary>
		''' PageImageID Attribute
		''' </summary>

		Public Overridable Property PageImageID As Nullable(Of Int32)
			Get 
				Return DirectCast(_Fields("PageImageID"), Nullable(Of Int32))
			End Get
			Set 
				_Fields("PageImageID") = value
			End Set
		End Property
		...
		''' <summary>
		''' PageImagePosition Attribute
		''' </summary>

		Public Overridable Property PageImagePosition As Nullable(Of Int32)
			Get 
				Return DirectCast(_Fields("PageImagePosition"), Nullable(Of Int32))
			End Get
			Set 
				_Fields("PageImagePosition") = value
			End Set
		End Property
	End Class
End Namespace
