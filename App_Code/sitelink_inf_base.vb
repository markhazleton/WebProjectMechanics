...
Namespace PMGEN
	...
	''' <summary>
	''' Summary description for SiteLinkinf_base
	''' </summary>

	Public MustInherit Class SiteLinkinf_base
		...
		Public Shared ReadOnly TableVar As String = "SiteLink"
		...
		Public Shared Function GetUserFilter() As String
			Dim objProfile As TableProfile = CustomProfile.GetTable(Share.ProjectName, SiteLinkinf.TableVar)
			...
			If (objProfile.isCollapsed AndAlso objProfile.MasterKey IsNot Nothing) Then
				...
				Dim masterKey As SiteLinkkey_base = TryCast(objProfile.MasterKey, SiteLinkkey_base)
		...
		Public Shared Function LoadKey(ByVal key As SiteLinkkey_base) As ArrayList 
		...
		Public Shared Function KeyUrl(ByVal key As SiteLinkkey_base ) As String
