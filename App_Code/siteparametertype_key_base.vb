...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class SiteParameterTypekey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				SiteParameterTypeID = Convert.ToInt32(values(0))
			End If
		...
		Private _SiteParameterTypeID As Int32
		Public Overridable Property SiteParameterTypeID As Int32
			Get 
		...
		Public Overloads Function Equals(ByVal obj As SiteParameterTypekey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.SiteParameterTypeID = obj.SiteParameterTypeID) AndAlso isEquals)
			Return isEquals
		End Function
		...
		Public Overrides Function ToString() As String
			...
			result.Append(Me.SiteParameterTypeID)
