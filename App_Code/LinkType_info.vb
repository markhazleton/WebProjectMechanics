...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cLinkType
		...
		Public ReadOnly Property LinkTypeCD() As cField
			Get
				If m_LinkTypeCD Is Nothing Then m_LinkTypeCD = New cField("LinkType", "x_LinkTypeCD", "LinkTypeCD", "[LinkTypeCD]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_LinkTypeCD
			End Get
		End Property
		...
		Public ReadOnly Property LinkTypeDesc() As cField
			Get
				If m_LinkTypeDesc Is Nothing Then m_LinkTypeDesc = New cField("LinkType", "x_LinkTypeDesc", "LinkTypeDesc", "[LinkTypeDesc]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property LinkTypeComment() As cField
			Get
				If m_LinkTypeComment Is Nothing Then m_LinkTypeComment = New cField("LinkType", "x_LinkTypeComment", "LinkTypeComment", "[LinkTypeComment]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
		...
		Public ReadOnly Property LinkTypeTarget() As cField
			Get
				If m_LinkTypeTarget Is Nothing Then m_LinkTypeTarget = New cField("LinkType", "x_LinkTypeTarget", "LinkTypeTarget", "[LinkTypeTarget]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
