...
Imports EW.Web
Namespace PMGEN
	Public MustInherit class SiteParameterTypedal_base
		...
		Dim objAdvancedSearchParm1 As SiteParameterTyperow ' Advanced Search Parm 1
		Dim objAdvancedSearchParm2 As SiteParameterTyperow ' Advanced Search Parm 2
		...
		Public Sub New (ByVal isUseSession As Boolean)
			...
			If (bUseSession) Then
				...
				' Advanced Search arguments 
				Dim sSearchName As String = Share.ProjectName + "_" + SiteParameterTypeinf.TableVar + "_Search1" 
				objAdvancedSearchParm1 = LoadSearch(sSearchName) 
				sSearchName = Share.ProjectName + "_" + SiteParameterTypeinf.TableVar + "_Search2" 
				objAdvancedSearchParm2 = LoadSearch(sSearchName) 
			Else
				objAdvancedSearchParm1 = New SiteParameterTyperow()
				objAdvancedSearchParm2 = New SiteParameterTyperow()
			End If
		End Sub
		...
		Public ReadOnly Property AdvancedSearchParm1 As SiteParameterTyperow 
			Get 
		...
		Public Readonly Property AdvancedSearchParm2 As SiteParameterTyperow 
			Get 
		...
		Private Sub SaveProperties()
			If (bUseSession) Then 
				...
				Dim sSearchName As String = String.Concat(Share.ProjectName, "_", SiteParameterTypeinf.TableVar, "_Search1") 
				SaveSearch(sSearchName, objAdvancedSearchParm1) 
				sSearchName = String.Concat(Share.ProjectName, "_", SiteParameterTypeinf.TableVar, "_Search2") 
		...
		Private Function LoadSearch(ByVal objectName As String) As SiteParameterTyperow 
			If (bUseSession) Then
				If (HttpContext.Current.Session(objectName) Is Nothing) Then
					HttpContext.Current.Session(objectName) = New SiteParameterTyperow()
				End If
				Return TryCast(HttpContext.Current.Session(objectName), SiteParameterTyperow)
			Else
				Return Nothing
			End If
		End Function
		...
		Private Sub SaveSearch(ByVal objectName As String, ByVal row As SiteParameterTyperow)
			If (bUseSession) Then
				If (HttpContext.Current.Session(objectName) Is Nothing) Then
					HttpContext.Current.Session(objectName) = New SiteParameterTyperow()
				End If
		...
		Private Function GetAdvancedSearch(ByVal row1 As SiteParameterTyperow, ByVal row2 As SiteParameterTyperow, ByRef parameters As DbParameterCollection ) As String 
			...
			If (bUseSession) Then
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SiteParameterTypeNM").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SiteParameterTypeNM] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SiteParameterTypeNM"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SiteParameterTypeNM", OleDbType.VarWChar)
					oParameter.Value = parm.Prefix + row1.SiteParameterTypeNM + parm.Suffix
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SiteParameterTypeNM").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SiteParameterTypeNM").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SiteParameterTypeNM] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SiteParameterTypeNM"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SiteParameterTypeNM", OleDbType.VarWChar)
					oParameter.Value = parm.Prefix + row2.SiteParameterTypeNM + parm.Suffix
					parameters.Add(oParameter)
				End If
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SiteParameterTypeDS").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SiteParameterTypeDS] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SiteParameterTypeDS"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SiteParameterTypeDS", OleDbType.VarWChar)
					oParameter.Value = parm.Prefix + row1.SiteParameterTypeDS + parm.Suffix
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SiteParameterTypeDS").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SiteParameterTypeDS").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SiteParameterTypeDS] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SiteParameterTypeDS"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SiteParameterTypeDS", OleDbType.VarWChar)
					oParameter.Value = parm.Prefix + row2.SiteParameterTypeDS + parm.Suffix
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SiteParameterTypeOrder").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SiteParameterTypeOrder] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SiteParameterTypeOrder"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SiteParameterTypeOrder", OleDbType.Integer)
					oParameter.Value = row1.SiteParameterTypeOrder
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SiteParameterTypeOrder").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SiteParameterTypeOrder").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SiteParameterTypeOrder] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SiteParameterTypeOrder"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SiteParameterTypeOrder", OleDbType.Integer)
					oParameter.Value = row2.SiteParameterTypeOrder
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SiteParameterTemplate").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SiteParameterTemplate] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SiteParameterTemplate"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SiteParameterTemplate", OleDbType.LongVarWChar)
					oParameter.Value = parm.Prefix + row1.SiteParameterTemplate + parm.Suffix
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SiteParameterTemplate").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SiteParameterTemplate").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SiteParameterTemplate] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SiteParameterTemplate"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SiteParameterTemplate", OleDbType.LongVarWChar)
					oParameter.Value = parm.Prefix + row2.SiteParameterTemplate + parm.Suffix
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
		...
		Public Overridable Function LoadRows(ByVal filter As String) As SiteParameterTyperow()
			Dim rows As SiteParameterTyperows = LoadList(filter)
			Dim array As SiteParameterTyperow() = Nothing
			If (rows IsNot Nothing) Then
				array = New SiteParameterTyperow(rows.Count - 1) {}
				rows.CopyTo(array, 0)
			End If
			Return array
		End Function
		...
		Private Function LoadDataViewFromSql(ByVal filter As String, ByVal orderBy As String, ByRef parameters As DbParameterCollection) As DataView 
			...
			Catch e As Exception
				...
				End If
				Throw New SiteParameterTypeDataException(strDbErrorMessage)
			End Try
		End Function
		...
		Public Overridable Function LoadList(ByVal filter As String) As SiteParameterTyperows 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
			...
			Try
				...
				If (dv Is Nothing) Then
					Return Nothing
				End If
				Dim rows As SiteParameterTyperows = New SiteParameterTyperows()
				For Each drv As DataRowView In dv
					Dim row As SiteParameterTyperow = GetRow(drv)
					rows.Add(row)
				Next
		...
		Public Overridable Function LoadList(ByVal filter As String, ByVal PageSize As Integer, ByVal StartRow As Integer) As SiteParameterTyperows 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
			Dim strWhere As String = SearchFilter(parameters) 
			Dim strMasterDetailWhere As String = MasterDetailFilter(parameters)
			If (Not String.IsNullOrEmpty(strMasterDetailWhere)) Then
		...
		Public Overridable Function LoadRow(ByVal key As SiteParameterTypekey, ByVal filter As String) As SiteParameterTyperow 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
		...
		Private Function GetRow(ByVal drv As DataRowView) As SiteParameterTyperow ' Get a row based on data reader
			...
			Try
				...
				If (Not DBNull.Value.Equals(drv("SiteParameterTypeNM"))) Then
					row.SiteParameterTypeNM = Convert.ToString(drv("SiteParameterTypeNM"))
				Else
					row.SiteParameterTypeNM = Nothing
				End If

				' Field SiteParameterTypeDS
				If (Not DBNull.Value.Equals(drv("SiteParameterTypeDS"))) Then
					row.SiteParameterTypeDS = Convert.ToString(drv("SiteParameterTypeDS"))
				Else
					row.SiteParameterTypeDS = Nothing
				End If

				' Field SiteParameterTypeOrder
				If (Not DBNull.Value.Equals(drv("SiteParameterTypeOrder"))) Then
					row.SiteParameterTypeOrder = Convert.ToInt32(drv("SiteParameterTypeOrder"))
				Else
					row.SiteParameterTypeOrder = Nothing
				End If

				' Field SiteParameterTemplate
				If (Not DBNull.Value.Equals(drv("SiteParameterTemplate"))) Then
					row.SiteParameterTemplate = Convert.ToString(drv("SiteParameterTemplate"))
				Else
					row.SiteParameterTemplate = Nothing
				End If
			Catch e As Exception
				Throw
			End Try
		...
		Public Overridable Sub Update(ByVal row As SiteParameterTyperow)
			Dim oParameter As OleDbParameter = Nothing
			...
			Try
				Using oConn As DbConnection = Db.GetConnection()
					Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
						...
						End If
						If (row.Attribute("SiteParameterTypeNM").AllowUpdate) Then
							oParameter = New OleDbParameter("SiteParameterTypeNM", OleDbType.VarWChar)
							If (row.SiteParameterTypeNM IsNot Nothing) Then
								oParameter.Value = DirectCast(row.SiteParameterTypeNM, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("SiteParameterTypeDS").AllowUpdate) Then
							oParameter = New OleDbParameter("SiteParameterTypeDS", OleDbType.VarWChar)
							If (row.SiteParameterTypeDS IsNot Nothing) Then
								oParameter.Value = DirectCast(row.SiteParameterTypeDS, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("SiteParameterTypeOrder").AllowUpdate) Then
							oParameter = New OleDbParameter("SiteParameterTypeOrder", OleDbType.Integer)
							If (row.SiteParameterTypeOrder.HasValue) Then
								oParameter.Value = DirectCast(row.SiteParameterTypeOrder, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("SiteParameterTemplate").AllowUpdate) Then
							oParameter = New OleDbParameter("SiteParameterTemplate", OleDbType.LongVarWChar)
							If (row.SiteParameterTemplate IsNot Nothing) Then
								oParameter.Value = DirectCast(row.SiteParameterTemplate, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						...
						' Key parameters
						oParameter = New OleDbParameter("SiteParameterTypeID", OleDbType.Integer)
						oParameter.Value = row.SiteParameterTypeID
		...
		Public Overridable Function Insert(ByVal row As SiteParameterTyperow) As SiteParameterTyperow 
			...
			Using oConn As DbConnection = Db.GetConnection()
				...
				Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
					Try
						...
						strDbErrorMessage = String.Empty
						bStatus = True ' Successful
						row.SiteParameterTypeID = Db.LastInsertedID(oConn) ' load auto-generated ID
		...
		Public Sub Delete(ByVal SiteParameterTypeID As Int32) 
			Dim oParameter As OleDbParameter = Nothing
			Dim bStatus As Boolean 
			...
			Try
				Using oConn As DbConnection = Db.GetConnection()
					Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
						...
						' Key parameters
						oParameter = New OleDbParameter("SiteParameterTypeID", OleDbType.Integer)
						oParameter.Value = SiteParameterTypeID
						oCmd.Parameters.Add(oParameter)
						oConn.Open()
						oCmd.ExecuteNonQuery()
		...
		Public Sub Delete(ByVal row As SiteParameterTyperow )
			Me.Delete(CType(row.SiteParameterTypeID, Int32))
		End Sub
		...
		Public Overridable Function KeyFilter(ByVal keys As ArrayList) As String 
			...
			Do While (i < keys.Count)
				...
				strWhere.Append(String.Concat("(", KeyFilter(DirectCast(keys(i), SiteParameterTypekey)), ")"))
				i += 1
			Loop
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal keys As ArrayList, ByRef parameters As DbParameterCollection) As String 
			...
			Do While (i < keys.Count)
				If (strWhere.Length > 0) Then strWhere.Append(" OR ") 
				strWhere.Append(String.Concat("(", KeyFilter(DirectCast(keys(i), SiteParameterTypekey), parameters, i), ")"))
				i += 1
			Loop
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As SiteParameterTypekey) As String 
			Dim strWhere As StringBuilder = New StringBuilder()

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append(String.Concat("[SiteParameterTypeID] = ", key.SiteParameterTypeID)) ' [SiteParameterTypeID] field
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As SiteParameterTypekey, ByRef parameters As DbParameterCollection) As String 
			Dim strWhere As StringBuilder = New StringBuilder()
			Dim oParameter As OleDbParameter = Nothing

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append("[SiteParameterTypeID] = " & Database.GetSqlParameterName(Db.DbType, "key__SiteParameterTypeID"))
			oParameter = New OleDbParameter("key__SiteParameterTypeID", OleDbType.Integer)
			oParameter.Value = key.SiteParameterTypeID
			parameters.Add(oParameter)
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As SiteParameterTypekey, ByRef parameters As DbParameterCollection, ByVal index As Integer) As String
			Dim strWhere As StringBuilder = New StringBuilder()
			Dim oParameter As OleDbParameter = Nothing

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append("[SiteParameterTypeID] = " & Database.GetSqlParameterName(Db.DbType, "key__SiteParameterTypeID" & index.ToString())) ' [SiteParameterTypeID] field
			oParameter = New OleDbParameter("key__SiteParameterTypeID" + index.ToString(), OleDbType.Integer)
			oParameter.Value = key.SiteParameterTypeID
			parameters.Add(oParameter)
			Return strWhere.ToString()
		End Function
		...
		Public Class SiteParameterTypeDataException 
			Inherits Exception
