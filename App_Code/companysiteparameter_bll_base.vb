...
Namespace PMGEN
	...
	''' <summary>
	''' Summary description for CompanySiteParameterbll
	''' Bussiness Layer (CompanySiteParameter)
	''' </summary>

	Public MustInherit Class CompanySiteParameterbll_base
		Public Sub New() 
		End Sub
		...
		Public Shared Function Inserting(ByVal row1 As CompanySiteParameterrow) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Inserted(ByVal row1 As CompanySiteParameterrow)
		...
		Public Shared Function Updating(ByVal row1 As CompanySiteParameterrow, ByVal row2 As CompanySiteParameterrow) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Updated(ByVal row1 As CompanySiteParameterrow, ByVal row2 As CompanySiteParameterrow)
		...
		Public Shared Function Deleting(ByVal rows As Collection(Of CompanySiteParameterrow)) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Deleted(ByVal rows As Collection(Of CompanySiteParameterrow))
			Dim i As Integer = 0
			Do While (i < rows.Count)
				WriteAuditTrail(DirectCast(rows(i), CompanySiteParameterrow), Nothing, Core.PageType.Delete)
				i += 1
			Loop
		End Sub
		...
		Private Shared Sub WriteAuditTrail(ByVal row1 As CompanySiteParameterrow, ByVal row2 As CompanySiteParameterrow, ByVal pt As Core.PageType)
			...
			Dim strTable As String = "CompanySiteParameter"
			...
			If (row1 IsNot Nothing) Then strKeys &= row1.CompanySiteParameterID.ToString() Else strKeys &= row2.CompanySiteParameterID.ToString()
