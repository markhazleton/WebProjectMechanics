...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class PageImagekey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				PageImageID = Convert.ToInt32(values(0))
			End If
		...
		Private _PageImageID As Int32
		Public Overridable Property PageImageID As Int32
			Get 
				return _PageImageID
			End Get
			Set 
		...
		Public Overloads Function Equals(ByVal obj As PageImagekey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.PageImageID = obj.PageImageID) AndAlso isEquals)
			Return isEquals
		End Function
