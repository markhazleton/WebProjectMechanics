...
Imports EW.Web
Namespace PMGEN
	Public MustInherit class CompanySiteParameterdal_base
		...
		Dim objAdvancedSearchParm1 As CompanySiteParameterrow ' Advanced Search Parm 1
		Dim objAdvancedSearchParm2 As CompanySiteParameterrow ' Advanced Search Parm 2
		...
		Public Sub New (ByVal isUseSession As Boolean)
			...
			If (bUseSession) Then
				...
				' Advanced Search arguments 
				Dim sSearchName As String = Share.ProjectName + "_" + CompanySiteParameterinf.TableVar + "_Search1" 
				objAdvancedSearchParm1 = LoadSearch(sSearchName) 
				sSearchName = Share.ProjectName + "_" + CompanySiteParameterinf.TableVar + "_Search2" 
				objAdvancedSearchParm2 = LoadSearch(sSearchName) 
			Else
				objAdvancedSearchParm1 = New CompanySiteParameterrow()
				objAdvancedSearchParm2 = New CompanySiteParameterrow()
			End If
		End Sub
		...
		Public ReadOnly Property AdvancedSearchParm1 As CompanySiteParameterrow 
			Get 
		...
		Public Readonly Property AdvancedSearchParm2 As CompanySiteParameterrow 
			Get 
		...
		Private Sub SaveProperties()
			If (bUseSession) Then 
				...
				Dim sSearchName As String = String.Concat(Share.ProjectName, "_", CompanySiteParameterinf.TableVar, "_Search1") 
				SaveSearch(sSearchName, objAdvancedSearchParm1) 
				sSearchName = String.Concat(Share.ProjectName, "_", CompanySiteParameterinf.TableVar, "_Search2") 
		...
		Private Function LoadSearch(ByVal objectName As String) As CompanySiteParameterrow 
			If (bUseSession) Then
				If (HttpContext.Current.Session(objectName) Is Nothing) Then
					HttpContext.Current.Session(objectName) = New CompanySiteParameterrow()
				End If
				Return TryCast(HttpContext.Current.Session(objectName), CompanySiteParameterrow)
			Else
				Return Nothing
			End If
		End Function
		...
		Private Sub SaveSearch(ByVal objectName As String, ByVal row As CompanySiteParameterrow)
			If (bUseSession) Then
				If (HttpContext.Current.Session(objectName) Is Nothing) Then
					HttpContext.Current.Session(objectName) = New CompanySiteParameterrow()
				End If
		...
		Private Function GetAdvancedSearch(ByVal row1 As CompanySiteParameterrow, ByVal row2 As CompanySiteParameterrow, ByRef parameters As DbParameterCollection ) As String 
			...
			If (bUseSession) Then
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SiteParameterTypeID").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SiteParameterTypeID] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SiteParameterTypeID"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SiteParameterTypeID", OleDbType.Integer)
					oParameter.Value = row1.SiteParameterTypeID
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SiteParameterTypeID").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SiteParameterTypeID").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SiteParameterTypeID] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SiteParameterTypeID"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SiteParameterTypeID", OleDbType.Integer)
					oParameter.Value = row2.SiteParameterTypeID
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
				...
				' SortOrder Field 
				parm = Core.SetAdvancedSearchParm(row1.Attribute("SortOrder").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([SortOrder] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__SortOrder"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__SortOrder", OleDbType.Integer)
					oParameter.Value = row1.SortOrder
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("SortOrder").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("SortOrder").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([SortOrder] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__SortOrder"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__SortOrder", OleDbType.Integer)
					oParameter.Value = row2.SortOrder
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
				...
				parm = Core.SetAdvancedSearchParm(row1.Attribute("ParameterValue").SearchType)
				strParmWhere.Remove(0, strParmWhere.Length)
				If (parm.Operator.Length > 0) Then
					strParmWhere.Append(String.Concat("([ParameterValue] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch1__ParameterValue"), ")"))
					oParameter = New OleDbParameter("AdvSearch1__ParameterValue", OleDbType.LongVarWChar)
					oParameter.Value = parm.Prefix + row1.ParameterValue + parm.Suffix
					parameters.Add(oParameter)
				End If
				parm = Core.SetAdvancedSearchParm(row2.Attribute("ParameterValue").SearchType)
				If (parm.Operator.Length > 0) Then
					If (strParmWhere.Length > 0) Then strParmWhere.Append(String.Concat(" ", row1.Attribute("ParameterValue").SearchCond.ToString(), " "))
					strParmWhere.Append(String.Concat("([ParameterValue] ", parm.Operator, " ",  Database.GetSqlParameterName(Db.DbType, "AdvSearch2__ParameterValue"), ")"))
					oParameter = New OleDbParameter("AdvSearch2__ParameterValue", OleDbType.LongVarWChar)
					oParameter.Value = parm.Prefix + row2.ParameterValue + parm.Suffix
					parameters.Add(oParameter)
				End If
				If (strParmWhere.Length > 0) Then 
					If (strWhere.Length > 0) Then strWhere.Append(" AND ")
		...
		Public Overridable Function LoadRows(ByVal filter As String) As CompanySiteParameterrow()
			Dim rows As CompanySiteParameterrows = LoadList(filter)
			Dim array As CompanySiteParameterrow() = Nothing
			If (rows IsNot Nothing) Then
				array = New CompanySiteParameterrow(rows.Count - 1) {}
				rows.CopyTo(array, 0)
			End If
			Return array
		End Function
		...
		Private Function LoadDataViewFromSql(ByVal filter As String, ByVal orderBy As String, ByRef parameters As DbParameterCollection) As DataView 
			...
			Catch e As Exception
				...
				End If
				Throw New CompanySiteParameterDataException(strDbErrorMessage)
			End Try
		End Function
		...
		Public Overridable Function LoadList(ByVal filter As String) As CompanySiteParameterrows 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
			...
			Try
				...
				If (dv Is Nothing) Then
					Return Nothing
				End If
				Dim rows As CompanySiteParameterrows = New CompanySiteParameterrows()
				For Each drv As DataRowView In dv
					Dim row As CompanySiteParameterrow = GetRow(drv)
					rows.Add(row)
				Next
		...
		Public Overridable Function LoadList(ByVal filter As String, ByVal PageSize As Integer, ByVal StartRow As Integer) As CompanySiteParameterrows 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
			Dim strWhere As String = SearchFilter(parameters) 
			Dim strMasterDetailWhere As String = MasterDetailFilter(parameters)
			If (Not String.IsNullOrEmpty(strMasterDetailWhere)) Then
		...
		Public Overridable Function LoadRow(ByVal key As CompanySiteParameterkey, ByVal filter As String) As CompanySiteParameterrow 
			Dim parameters As DbParameterCollection = Db.GetParameterCollection()
		...
		Private Function GetRow(ByVal drv As DataRowView) As CompanySiteParameterrow ' Get a row based on data reader
			Dim row As CompanySiteParameterrow = New CompanySiteParameterrow()
			Try

				' Field CompanySiteParameterID
				If (Not DBNull.Value.Equals(drv("CompanySiteParameterID"))) Then
					row.CompanySiteParameterID = Convert.ToInt32(drv("CompanySiteParameterID"))
				Else
					row.CompanySiteParameterID = Nothing
				End If
				...
				If (Not DBNull.Value.Equals(drv("SiteParameterTypeID"))) Then
					row.SiteParameterTypeID = Convert.ToInt32(drv("SiteParameterTypeID"))
				Else
					row.SiteParameterTypeID = Nothing
				End If

				' Field SortOrder
				If (Not DBNull.Value.Equals(drv("SortOrder"))) Then
					row.SortOrder = Convert.ToInt32(drv("SortOrder"))
				Else
					row.SortOrder = Nothing
				End If

				' Field ParameterValue
				If (Not DBNull.Value.Equals(drv("ParameterValue"))) Then
					row.ParameterValue = Convert.ToString(drv("ParameterValue"))
				Else
					row.ParameterValue = Nothing
				End If
			Catch e As Exception
				Throw
			End Try
			...
			Select Case fieldName
				Case "CompanyID"
					...
					If (value IsNot Nothing AndAlso value.Length > 0 AndAlso DataFormat.CheckInt32(value)) Then ' validate
						...
						sDispFld2 = ""
					End If
				Case "SiteParameterTypeID"

					' linking sql & fields (Generated depends on Settings)
					If (value IsNot Nothing AndAlso value.Length > 0 AndAlso DataFormat.CheckInt32(value)) Then ' validate
						sSql = "SELECT [SiteParameterTypeID], [SiteParameterTypeNM] FROM [SiteParameterType] WHERE "
						sSql &= String.Concat("[SiteParameterTypeID]=", Db.AdjustSql(value), " ORDER BY [SiteParameterTypeNM] Asc")						
						sDispFld1 = "SiteParameterTypeNM"
						sDispFld2 = ""
					End If
			End Select
		...
		Public Shared Function LookUpTable(ByVal fieldName As String) As DataView 
			...
			Select Case fieldName
				...
				' linking sql & fields (Generated depends on Settings)
					sSql = "SELECT [SiteParameterTypeID], [SiteParameterTypeNM] FROM [SiteParameterType]"
					sSql &= " ORDER BY [SiteParameterTypeNM] Asc"
					sLnkFld = "SiteParameterTypeID"
					sDispFld1 = "SiteParameterTypeNM"
					sDispFld2 = "" 
			End Select
		...
		Public Overridable Sub Update(ByVal row As CompanySiteParameterrow)
			Dim oParameter As OleDbParameter = Nothing
			...
			Try
				Using oConn As DbConnection = Db.GetConnection()
					Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
						If (row.Attribute("CompanySiteParameterID").AllowUpdate) Then
							oParameter = New OleDbParameter("CompanySiteParameterID", OleDbType.Integer)
							If (row.CompanySiteParameterID.HasValue) Then
								oParameter.Value = DirectCast(row.CompanySiteParameterID, Object)
							Else
						...
						If (row.Attribute("CompanyID").AllowUpdate) Then
							...
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("SiteParameterTypeID").AllowUpdate) Then
							oParameter = New OleDbParameter("SiteParameterTypeID", OleDbType.Integer)
							If (row.SiteParameterTypeID.HasValue) Then
								oParameter.Value = DirectCast(row.SiteParameterTypeID, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("SortOrder").AllowUpdate) Then
							oParameter = New OleDbParameter("SortOrder", OleDbType.Integer)
							If (row.SortOrder.HasValue) Then
								oParameter.Value = DirectCast(row.SortOrder, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						End If
						If (row.Attribute("ParameterValue").AllowUpdate) Then
							oParameter = New OleDbParameter("ParameterValue", OleDbType.LongVarWChar)
							If (row.ParameterValue IsNot Nothing) Then
								oParameter.Value = DirectCast(row.ParameterValue, Object)
							Else
								oParameter.Value = DBNull.Value
							End If
							oCmd.Parameters.Add(oParameter) ' Update or Remove
						...
						' Key parameters
						oParameter = New OleDbParameter("CompanySiteParameterID", OleDbType.Integer)
						oParameter.Value = row.CompanySiteParameterID
		...
		Public Overridable Function Insert(ByVal row As CompanySiteParameterrow) As CompanySiteParameterrow 
			...
			Using oConn As DbConnection = Db.GetConnection()
				...
				Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
					Try
						...
						strDbErrorMessage = String.Empty
						bStatus = True ' Successful
						row.CompanySiteParameterID = Db.LastInsertedID(oConn) ' load auto-generated ID
		...
		Public Sub Delete(ByVal CompanySiteParameterID As Int32) 
			Dim oParameter As OleDbParameter = Nothing
			Dim bStatus As Boolean 
			...
			Try
				Using oConn As DbConnection = Db.GetConnection()
					Using oCmd As DbCommand = Db.GetCommand(sSql, oConn)
						...
						' Key parameters
						oParameter = New OleDbParameter("CompanySiteParameterID", OleDbType.Integer)
						oParameter.Value = CompanySiteParameterID
						oCmd.Parameters.Add(oParameter)
						oConn.Open()
						oCmd.ExecuteNonQuery()
		...
		Public Sub Delete(ByVal row As CompanySiteParameterrow )
			Me.Delete(CType(row.CompanySiteParameterID, Int32))
		End Sub
		...
		Public Overridable Function KeyFilter(ByVal keys As ArrayList) As String 
			...
			Do While (i < keys.Count)
				...
				strWhere.Append(String.Concat("(", KeyFilter(DirectCast(keys(i), CompanySiteParameterkey)), ")"))
				i += 1
			Loop
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal keys As ArrayList, ByRef parameters As DbParameterCollection) As String 
			...
			Do While (i < keys.Count)
				If (strWhere.Length > 0) Then strWhere.Append(" OR ") 
				strWhere.Append(String.Concat("(", KeyFilter(DirectCast(keys(i), CompanySiteParameterkey), parameters, i), ")"))
				i += 1
			Loop
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As CompanySiteParameterkey) As String 
			Dim strWhere As StringBuilder = New StringBuilder()

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append(String.Concat("[CompanySiteParameterID] = ", key.CompanySiteParameterID)) ' [CompanySiteParameterID] field
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As CompanySiteParameterkey, ByRef parameters As DbParameterCollection) As String 
			Dim strWhere As StringBuilder = New StringBuilder()
			Dim oParameter As OleDbParameter = Nothing

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append("[CompanySiteParameterID] = " & Database.GetSqlParameterName(Db.DbType, "key__CompanySiteParameterID"))
			oParameter = New OleDbParameter("key__CompanySiteParameterID", OleDbType.Integer)
			oParameter.Value = key.CompanySiteParameterID
			parameters.Add(oParameter)
			Return strWhere.ToString()
		End Function
		...
		Public Overridable Function KeyFilter(ByVal key As CompanySiteParameterkey, ByRef parameters As DbParameterCollection, ByVal index As Integer) As String
			Dim strWhere As StringBuilder = New StringBuilder()
			Dim oParameter As OleDbParameter = Nothing

			' Key parameters
			If (strWhere.Length > 0) Then strWhere.Append(" AND ")
			strWhere.Append("[CompanySiteParameterID] = " & Database.GetSqlParameterName(Db.DbType, "key__CompanySiteParameterID" & index.ToString())) ' [CompanySiteParameterID] field
			oParameter = New OleDbParameter("key__CompanySiteParameterID" + index.ToString(), OleDbType.Integer)
			oParameter.Value = key.CompanySiteParameterID
			parameters.Add(oParameter)
			Return strWhere.ToString()
		End Function
		...
		Public Class CompanySiteParameterDataException 
			Inherits Exception
