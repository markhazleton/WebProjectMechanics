...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class SiteLinkrow_base
		...
		Public Function GetKey() As SiteLinkkey
			Dim key As SiteLinkkey = New SiteLinkkey()
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As SiteLinkrow = (DirectCast(obj, SiteLinkrow))
		...
		Public Sub SetPageType(ByVal pt As Core.PageType)
			Dim info As SiteLinkinf = New SiteLinkinf()
