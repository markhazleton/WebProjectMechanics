...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class LinkTyperow_base
		...
		Public Function GetKey() As LinkTypekey
			Dim key As LinkTypekey = New LinkTypekey()
			key.LinkTypeCD = CType(Me.LinkTypeCD,String) 
			Return key
		End Function
		...
		Public Sub New()
			...
			Add("LinkTypeDesc", GetType(String)) ' LinkTypeDesc Attribute
			Add("LinkTypeComment", GetType(String)) ' LinkTypeComment Attribute
			Add("LinkTypeTarget", GetType(String)) ' LinkTypeTarget Attribute
		End Sub
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As LinkTyperow = (DirectCast(obj, LinkTyperow))
		...
		''' <summary>
		''' LinkTypeDesc Attribute
		''' </summary>

		Public Overridable Property LinkTypeDesc As String
			Get 
				Return DirectCast(_Fields("LinkTypeDesc"), String)
			End Get
			Set 
				_Fields("LinkTypeDesc") = value
			End Set
		End Property

		''' <summary>
		''' LinkTypeComment Attribute
		''' </summary>

		Public Overridable Property LinkTypeComment As String
			Get 
				Return DirectCast(_Fields("LinkTypeComment"), String)
			End Get
			Set 
				_Fields("LinkTypeComment") = value
			End Set
		End Property

		''' <summary>
		''' LinkTypeTarget Attribute
		''' </summary>

		Public Overridable Property LinkTypeTarget As String
			Get 
				Return DirectCast(_Fields("LinkTypeTarget"), String)
			End Get
			Set 
				_Fields("LinkTypeTarget") = value
			End Set
		End Property
	End Class
End Namespace
