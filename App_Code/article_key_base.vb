...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class Articlekey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				ArticleID = Convert.ToInt32(values(0))
			End If
		...
		Public Overridable Property ArticleID As Int32
			Get 
				return _ArticleID
			End Get
			Set 
		...
		Public Overloads Function Equals(ByVal obj As Articlekey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.ArticleID = obj.ArticleID) AndAlso isEquals)
			Return isEquals
		End Function
