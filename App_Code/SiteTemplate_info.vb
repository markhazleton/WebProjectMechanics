...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cSiteTemplate
		...
		Public ReadOnly Property TemplatePrefix() As cField
			Get
				If m_TemplatePrefix Is Nothing Then m_TemplatePrefix = New cField("SiteTemplate", "x_TemplatePrefix", "TemplatePrefix", "[TemplatePrefix]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property zName() As cField
			Get
				If m_zName Is Nothing Then m_zName = New cField("SiteTemplate", "x_zName", "Name", "[Name]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_zName
			End Get
		End Property
		...
		Public ReadOnly Property Top() As cField
			Get
				If m_Top Is Nothing Then m_Top = New cField("SiteTemplate", "x_Top", "Top", "[Top]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
				Return m_Top
			End Get
		End Property
		...
		Public ReadOnly Property Bottom() As cField
			Get
				If m_Bottom Is Nothing Then m_Bottom = New cField("SiteTemplate", "x_Bottom", "Bottom", "[Bottom]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
				Return m_Bottom
			End Get
		End Property
		...
		Public ReadOnly Property CSS() As cField
			Get
				If m_CSS Is Nothing Then m_CSS = New cField("SiteTemplate", "x_CSS", "CSS", "[CSS]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
				Return m_CSS
			End Get
		End Property
