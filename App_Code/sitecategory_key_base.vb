...
Namespace PMGEN
	...
	<Serializable> _ 
	Public MustInherit Class SiteCategorykey_base
		...
		Public Sub SetupValues(ByVal values() As String)
			...
			If (Not String.IsNullOrEmpty(values(0))) Then
				SiteCategoryID = Convert.ToInt32(values(0))
			End If
		...
		Private _SiteCategoryID As Int32
		Public Overridable Property SiteCategoryID As Int32
			Get 
		...
		Public Overloads Function Equals(ByVal obj As SiteCategorykey_base) As Boolean
			If (obj Is Nothing) Then Return False
			Dim isEquals As Boolean = True
			isEquals = ((Me.SiteCategoryID = obj.SiteCategoryID) AndAlso isEquals)
			Return isEquals
		End Function
		...
		Public Overrides Function ToString() As String
			...
			result.Append(Me.SiteCategoryID)
