...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cSiteParameterType
		...
		Public ReadOnly Property SiteParameterTypeID() As cField
			Get
				If m_SiteParameterTypeID Is Nothing Then m_SiteParameterTypeID = New cField("SiteParameterType", "x_SiteParameterTypeID", "SiteParameterTypeID", "[SiteParameterTypeID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SiteParameterTypeNM() As cField
			Get
				If m_SiteParameterTypeNM Is Nothing Then m_SiteParameterTypeNM = New cField("SiteParameterType", "x_SiteParameterTypeNM", "SiteParameterTypeNM", "[SiteParameterTypeNM]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteParameterTypeDS() As cField
			Get
				If m_SiteParameterTypeDS Is Nothing Then m_SiteParameterTypeDS = New cField("SiteParameterType", "x_SiteParameterTypeDS", "SiteParameterTypeDS", "[SiteParameterTypeDS]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteParameterTypeOrder() As cField
			Get
				If m_SiteParameterTypeOrder Is Nothing Then m_SiteParameterTypeOrder = New cField("SiteParameterType", "x_SiteParameterTypeOrder", "SiteParameterTypeOrder", "[SiteParameterTypeOrder]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SiteParameterTemplate() As cField
			Get
				If m_SiteParameterTemplate Is Nothing Then m_SiteParameterTemplate = New cField("SiteParameterType", "x_SiteParameterTemplate", "SiteParameterTemplate", "[SiteParameterTemplate]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
