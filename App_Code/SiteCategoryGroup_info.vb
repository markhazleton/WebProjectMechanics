...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cSiteCategoryGroup
		...
		Public ReadOnly Property SiteCategoryGroupID() As cField
			Get
				If m_SiteCategoryGroupID Is Nothing Then m_SiteCategoryGroupID = New cField("SiteCategoryGroup", "x_SiteCategoryGroupID", "SiteCategoryGroupID", "[SiteCategoryGroupID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SiteCategoryGroupNM() As cField
			Get
				If m_SiteCategoryGroupNM Is Nothing Then m_SiteCategoryGroupNM = New cField("SiteCategoryGroup", "x_SiteCategoryGroupNM", "SiteCategoryGroupNM", "[SiteCategoryGroupNM]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryGroupDS() As cField
			Get
				If m_SiteCategoryGroupDS Is Nothing Then m_SiteCategoryGroupDS = New cField("SiteCategoryGroup", "x_SiteCategoryGroupDS", "SiteCategoryGroupDS", "[SiteCategoryGroupDS]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryGroupOrder() As cField
			Get
				If m_SiteCategoryGroupOrder Is Nothing Then m_SiteCategoryGroupOrder = New cField("SiteCategoryGroup", "x_SiteCategoryGroupOrder", "SiteCategoryGroupOrder", "[SiteCategoryGroupOrder]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
