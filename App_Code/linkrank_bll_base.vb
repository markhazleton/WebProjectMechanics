...
Namespace PMGEN
	...
	''' <summary>
	''' Summary description for LinkRankbll
	''' Bussiness Layer (LinkRank)
	''' </summary>

	Public MustInherit Class LinkRankbll_base
		Public Sub New() 
		End Sub
		...
		Public Shared Function Inserting(ByVal row1 As LinkRankrow) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Inserted(ByVal row1 As LinkRankrow)
		...
		Public Shared Function Updating(ByVal row1 As LinkRankrow, ByVal row2 As LinkRankrow) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Updated(ByVal row1 As LinkRankrow, ByVal row2 As LinkRankrow)
		...
		Public Shared Function Deleting(ByVal rows As Collection(Of LinkRankrow)) As Boolean
			Return True
		End Function
		...
		Public Shared Sub Deleted(ByVal rows As Collection(Of LinkRankrow))
			Dim i As Integer = 0
			Do While (i < rows.Count)
				WriteAuditTrail(DirectCast(rows(i), LinkRankrow), Nothing, Core.PageType.Delete)
				i += 1
			Loop
		End Sub
		...
		Private Shared Sub WriteAuditTrail(ByVal row1 As LinkRankrow, ByVal row2 As LinkRankrow, ByVal pt As Core.PageType)
			...
			Dim strTable As String = "LinkRank"
