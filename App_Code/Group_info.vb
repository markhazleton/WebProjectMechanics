...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cGroup
		...
		Public ReadOnly Property GroupID() As cField
			Get
				If m_GroupID Is Nothing Then m_GroupID = New cField("Group", "x_GroupID", "GroupID", "[GroupID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_GroupID
			End Get
		End Property
		...
		Public ReadOnly Property GroupName() As cField
			Get
				If m_GroupName Is Nothing Then m_GroupName = New cField("Group", "x_GroupName", "GroupName", "[GroupName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_GroupName
			End Get
		End Property
		...
		Public ReadOnly Property GroupComment() As cField
			Get
				If m_GroupComment Is Nothing Then m_GroupComment = New cField("Group", "x_GroupComment", "GroupComment", "[GroupComment]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
