...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class PageTyperow_base
		...
		Public Function GetKey() As PageTypekey
			Dim key As PageTypekey = New PageTypekey()
			key.PageTypeID = CType(Me.PageTypeID,Int32) 
			Return key
		End Function
		...
		Public Sub New()
			...
			Add("PageTypeCD", GetType(String)) ' PageTypeCD Attribute
			Add("PageTypeDesc", GetType(String)) ' PageTypeDesc Attribute
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As PageTyperow = (DirectCast(obj, PageTyperow))
		...
		''' <summary>
		''' PageTypeCD Attribute
		''' </summary>

		Public Overridable Property PageTypeCD As String
			Get 
				Return DirectCast(_Fields("PageTypeCD"), String)
			End Get
			Set 
				_Fields("PageTypeCD") = value
			End Set
		End Property

		''' <summary>
		''' PageTypeDesc Attribute
		''' </summary>

		Public Overridable Property PageTypeDesc As String
			Get 
				Return DirectCast(_Fields("PageTypeDesc"), String)
			End Get
			Set 
				_Fields("PageTypeDesc") = value
			End Set
		End Property
