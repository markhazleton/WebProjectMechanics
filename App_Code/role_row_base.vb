...
Namespace PMGEN
	<Serializable()> _
	Public MustInherit Class rolerow_base
		...
		Public Function GetKey() As rolekey
			Dim key As rolekey = New rolekey()
			key.RoleID = CType(Me.RoleID,Int32) 
			Return key
		End Function
		...
		Public Sub New()
			...
			Add("RoleName", GetType(String)) ' RoleName Attribute
			Add("RoleTitle", GetType(String)) ' RoleTitle Attribute
			Add("RoleComment", GetType(String)) ' RoleComment Attribute
			Add("FilterMenu", GetType(Nullable(Of Boolean))) ' FilterMenu Attribute
		End Sub
		...
		Public Overrides Function Equals(ByVal obj As Object) As Boolean
			If (obj Is Nothing) Then
				Return False
			End If
			Dim row2 As rolerow = (DirectCast(obj, rolerow))
		...
		Public Sub SetPageType(ByVal pt As Core.PageType)
			Dim info As roleinf = New roleinf()
		...
		Public Overridable Property RoleName As String
			Get 
				Return DirectCast(_Fields("RoleName"), String)
			End Get
			Set 
				_Fields("RoleName") = value
			End Set
		End Property
		...
		Public Overridable Property RoleTitle As String
			Get 
				Return DirectCast(_Fields("RoleTitle"), String)
			End Get
			Set 
				_Fields("RoleTitle") = value
			End Set
		End Property

		''' <summary>
		''' RoleComment Attribute
		''' </summary>

		Public Overridable Property RoleComment As String
			Get 
				Return DirectCast(_Fields("RoleComment"), String)
			End Get
			Set 
				_Fields("RoleComment") = value
			End Set
		End Property

		''' <summary>
		''' FilterMenu Attribute
		''' </summary>

		Public Overridable Property FilterMenu As Nullable(Of Boolean)
			Get 
				Return DirectCast(_Fields("FilterMenu"), Nullable(Of Boolean))
			End Get
			Set 
				_Fields("FilterMenu") = value
			End Set
		End Property
	End Class
End Namespace
