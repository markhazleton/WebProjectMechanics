...
#Region "Public Methods"
    ...
    Public Function BuildLinkListBySibling(ByVal LocationID As String, ByVal ParentLocationID As String) As String
        ...
        Return sReturn.ToString
    End Function
    Public Function BuildLinkListByParent(ByVal LocationID As String, ByVal ParentLocationID As String) As String
        Dim sReturn As New StringBuilder(String.Empty)
        Dim sParentPageName As String = String.Empty
    ...
    Public Function BreadCrumbWithChildren(ByVal BreadCrumb As String, ByVal LocationID As String, ByVal ParentLocationID As String) As String
        Dim sReturn As New StringBuilder(String.Empty)
        Dim sParentPageName As String = String.Empty
