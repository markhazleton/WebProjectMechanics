...
Public Class LocationList
    ...
    Public Function GetLocationListFromDb(ByVal OrderBy As String, ByVal CompanyID As String, ByVal GroupID As String) As Boolean
        ...
        For Each myrow As DataRow In ApplicationDAL.GetSiteMap(OrderBy, CompanyID, GroupID).Rows
            ...
            MySiteRow.ImageID = wpm_GetDBInteger(myrow("ImageID"))
            ...
            MySiteRow.RecordSource = wpm_GetDBString(myrow("RecordSource"))
            MySiteRow.SiteCategoryName = wpm_GetDBString(myrow("SiteCategoryNM"))
            MySiteRow.LocationGroupNM = wpm_GetDBString(myrow("SiteCategoryGroupNM"))
            ...
            MySiteRow.ImageFileName = wpm_GetDBString(myrow("ImageFileName"))
            MySiteRow.LocationAuthor = wpm_GetDBString(myrow("LocationAuthor"))

            MySiteRow.RowsPerPage = wpm_GetDBInteger(myrow("RowsPerPage"))
            MySiteRow.ImagesPerRow = wpm_GetDBInteger(myrow("ImagesPerRow"))

            MySiteRow.IncludeInNavigation = wpm_GetDBBoolean(myrow("UseInNavigation"))
            MySiteRow.LocationBody = wpm_GetDBString(myrow("Body"))
            MySiteRow.LocationSummary = wpm_GetDBString(myrow("Summary"))
