...
Friend Class parser
    ...
    Private Function EmitCallFunction(ByRef valueLeft As opCode, ByVal funcName As String, ByVal parameters As ArrayList, ByVal CallType As eCallType, ByVal ErrorIfNotFound As Boolean) As Boolean
        ...
        If Not newOpcode Is Nothing Then
            ...
            Return True
        Else
            If ErrorIfNotFound Then mTokenizer.RaiseError(String.Format("Variable or method {0} was not found", funcName))
            Return False
        End If
    End Function
        ...
        If Not parameters Is Nothing Then
            ...
            If ParamsNotUsed Then
                If t.IsArray Then
                    ...
                    Else
                        mTokenizer.RaiseError(String.Format("This array has {0} dimensions", t.GetArrayRank))
                    End If
                Else
                    Dim mi As MemberInfo
