...
<script runat="server">
	...
	Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
		objProfile = CustomProfile.GetTable(Share.ProjectName, "SiteLink")
	End Sub
	...
	Protected Sub SiteLinkDetailsView_DataBound(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim control As DetailsView = SiteLinkDetailsView
	...
	Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim sUrl As String = "sitelink_edit.aspx?" + SiteLinkinf.KeyUrl(key)
	...
	Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim sUrl As String = "sitelink_add.aspx?" + SiteLinkinf.KeyUrl(key)
		Response.Redirect(sUrl)
	End Sub
	...
	Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		Response.Redirect("sitelink_list.aspx")
	End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
	<p><span class="aspnetmaker">View TABLE: Site Link</span></p>
	<p>
		<asp:Hyperlink id="lnkList" Text="Back to List" NavigateUrl="sitelink_list.aspx" CssClass="aspnetmaker" runat="server" />
		<asp:Label id="lblReturnUrl" Visible="False" Text="sitelink_list.aspx" CssClass="aspnetmaker" runat="server" />
	</p>
