...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal s As Object, ByVal e As System.EventArgs)
		...
		If (Not Page.IsPostBack) Then
			...
			End If
		Else
			key = TryCast(ViewState("key"), Pagekey) ' restore from ViewState for postback
		End If
	...
	Protected Sub PageDetailsView_DataBound(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		If (PageDetailsView.CurrentMode = DetailsViewMode.Edit) Then
			If (row IsNot Nothing) Then
				key.PageID = Convert.ToInt32(row.PageID)
			End If
	...
	Protected Sub PageDetailsView_ItemUpdating(ByVal sender As Object, ByVal e As DetailsViewUpdateEventArgs)
	...
	Protected Sub PageDetailsView_ItemUpdated(ByVal sender As Object, ByVal e As DetailsViewUpdatedEventArgs)
		...
		If (e.AffectedRows = 0) Then
			...
			Dim oldrow As Pagerow = New Pagerow()
	...
	Protected Sub PageDataSource_Updating(ByVal sender As Object, ByVal e As ObjectDataSourceMethodEventArgs)
		Dim source As DetailsView = PageDetailsView
		...
		Dim data As Pagedal = New Pagedal()
		key.PageID = Convert.ToInt32(row.PageID)
		oldrow = data.LoadRow(key, Pageinf.GetUserFilter())
		ControlToRow(row, source) ' load values of controls to row
		newrow = row
		If (Pagebll.Updating(oldrow, newrow)) Then
		Else
			e.Cancel = True
	...
	Protected Sub PageDataSource_Updated(ByVal sender As Object, ByVal e As ObjectDataSourceStatusEventArgs)
		If (e.Exception IsNot Nothing) Then
			e.AffectedRows = 0
...
//-->
	...
	<p><span class="aspnetmaker">Edit TABLE: Page</span></p>
	<p>
...
<asp:ObjectDataSource ID="PageDataSource"
	...
	OnUpdating="PageDataSource_Updating"
	OnUpdated="PageDataSource_Updated"
	runat="server">
...
<!-- DetailsView -->
	<asp:DetailsView ID="PageDetailsView"
		...
		OnItemUpdating="PageDetailsView_ItemUpdating"
...
<asp:DropDownList ID="x_SiteCategoryGroupID" CssClass="aspnetmaker" runat="server" >
			...
			<asp:TemplateField ShowHeader="False">
				...
				<asp:HiddenField id="x_PageID" runat="server" />
				</EditItemTemplate>
			</asp:TemplateField>
		</Fields>
	</asp:DetailsView>
