...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal s As Object, ByVal e As System.EventArgs)
		...
		If (Not Page.IsPostBack) Then
			...
			End If
		Else
			key = TryCast(ViewState("key"), Linkkey) ' restore from ViewState for postback
		End If
	...
	Protected Sub LinkDetailsView_DataBound(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		If (LinkDetailsView.CurrentMode = DetailsViewMode.Edit) Then
	...
	Protected Sub LinkDetailsView_ItemUpdating(ByVal sender As Object, ByVal e As DetailsViewUpdateEventArgs)
	...
	Protected Sub LinkDetailsView_ItemUpdated(ByVal sender As Object, ByVal e As DetailsViewUpdatedEventArgs)
		...
		If (e.AffectedRows = 0) Then
			...
			Dim oldrow As Linkrow = New Linkrow()
	...
	Protected Sub LinkDataSource_Updating(ByVal sender As Object, ByVal e As ObjectDataSourceMethodEventArgs)
		Dim source As DetailsView = LinkDetailsView
		...
		Dim data As Linkdal = New Linkdal()
		key.ID = Convert.ToInt32(row.ID)
		oldrow = data.LoadRow(key, Linkinf.GetUserFilter())
		ControlToRow(row, source) ' load values of controls to row
		newrow = row
		If (Linkbll.Updating(oldrow, newrow)) Then
		Else
			e.Cancel = True
	...
	Protected Sub LinkDataSource_Updated(ByVal sender As Object, ByVal e As ObjectDataSourceStatusEventArgs)
		If (e.Exception IsNot Nothing) Then
			e.AffectedRows = 0
...
//-->
	...
	<p><span class="aspnetmaker">Edit TABLE: Link</span></p>
	<p>
...
<asp:ObjectDataSource ID="LinkDataSource"
	...
	OnUpdating="LinkDataSource_Updating"
	OnUpdated="LinkDataSource_Updated"
	runat="server">
...
<!-- DetailsView -->
	<asp:DetailsView ID="LinkDetailsView"
		...
		OnItemUpdating="LinkDetailsView_ItemUpdating"
		OnItemUpdated="LinkDetailsView_ItemUpdated"
