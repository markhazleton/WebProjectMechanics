...
<script runat="server">
	...
	Dim oldrows As PageAliasrows 
	Private objProfile As TableProfile ' table profile

	' *************************
	' *  Handler for Page_Init
	' *************************

	Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs)
		objProfile = CustomProfile.GetTable(Share.ProjectName, "PageAlias")
	End Sub
	...
	Protected Sub PageAliasDetailsView_DataBound(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim control As DetailsView = PageAliasDetailsView
		Dim row As PageAliasrow = TryCast(PageAliasDetailsView.DataItem, PageAliasrow)' get data object
		RowToControl(row, control, Core.CtrlType.View)
        key = row.GetKey()
        ViewState("key") = key
	End Sub
	...
	Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim sUrl As String = "pagealias_edit.aspx?" + PageAliasinf.KeyUrl(key)
	...
	Protected Sub btnCopy_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		Dim sUrl As String = "pagealias_add.aspx?" + PageAliasinf.KeyUrl(key)
		Response.Redirect(sUrl)
	End Sub
	...
	Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		Response.Redirect("pagealias_list.aspx")
	End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
	<p><span class="aspnetmaker">View TABLE: Page Alias</span></p>
	<p>
		<asp:Hyperlink id="lnkList" Text="Back to List" NavigateUrl="pagealias_list.aspx" CssClass="aspnetmaker" runat="server" />
		<asp:Label id="lblReturnUrl" Visible="False" Text="pagealias_list.aspx" CssClass="aspnetmaker" runat="server" />
	</p>
...
<asp:Label id="x_CompanyID" CssClass="aspnetmaker" runat="server" />
			...
			<asp:TemplateField ShowHeader="False">
				...
				<ItemTemplate>
				<table border="0">
				<td><asp:LinkButton ID="btnEdit" CssClass="aspnetmaker" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit" OnClick="btnEdit_Click"></asp:LinkButton></td>
				<td><asp:LinkButton ID="btnCopy" CssClass="aspnetmaker" runat="server"  CausesValidation="False" CommandName="New" Text="Copy" OnClick="btnCopy_Click"></asp:LinkButton></td>
				<td><asp:LinkButton ID="btnDelete" CssClass="aspnetmaker" runat="server" CausesValidation="False" Text="Delete" OnClientClick="if (!ew_ConfirmDelete('Do you want to delete this record?')) return false;"  OnClick="btnDelete_Click"></asp:LinkButton></td>
				</table>
				</ItemTemplate>
			</asp:TemplateField>
		</Fields>
