...
<script runat="server">
	...
	Protected Sub Page_Load(ByVal s As Object, ByVal e As System.EventArgs)
		...
		If (Not Page.IsPostBack) Then
			...
			End If
		Else
			key = TryCast(ViewState("key"), Imagekey) ' restore from ViewState for postback
		End If
	...
	Protected Sub ImageDetailsView_DataBound(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		If (ImageDetailsView.CurrentMode = DetailsViewMode.Edit) Then
			If (row IsNot Nothing) Then
				key.ImageID = Convert.ToInt32(row.ImageID)
			End If
	...
	Protected Sub ImageDetailsView_ItemUpdating(ByVal sender As Object, ByVal e As DetailsViewUpdateEventArgs)
	...
	Protected Sub ImageDetailsView_ItemUpdated(ByVal sender As Object, ByVal e As DetailsViewUpdatedEventArgs)
		...
		If (e.AffectedRows = 0) Then
			...
			Dim oldrow As Imagerow = New Imagerow()
	...
	Protected Sub ImageDataSource_Updating(ByVal sender As Object, ByVal e As ObjectDataSourceMethodEventArgs)
		Dim source As DetailsView = ImageDetailsView
		...
		Dim data As Imagedal = New Imagedal()
		key.ImageID = Convert.ToInt32(row.ImageID)
		oldrow = data.LoadRow(key, Imageinf.GetUserFilter())
		ControlToRow(row, source) ' load values of controls to row
		newrow = row
		If (Imagebll.Updating(oldrow, newrow)) Then
		Else
			e.Cancel = True
	...
	Protected Sub ImageDataSource_Updated(ByVal sender As Object, ByVal e As ObjectDataSourceStatusEventArgs)
		If (e.Exception IsNot Nothing) Then
			e.AffectedRows = 0
		...
		Else
			...
			Imagebll.Updated(oldrow, newrow)
		End If
...
//-->
	...
	<p><span class="aspnetmaker">Edit TABLE: Image</span></p>
	<p>
...
<asp:ObjectDataSource ID="ImageDataSource"
	...
	OnUpdating="ImageDataSource_Updating"
	OnUpdated="ImageDataSource_Updated"
	runat="server">
...
<!-- DetailsView -->
	<asp:DetailsView ID="ImageDetailsView"
		...
		OnItemUpdating="ImageDetailsView_ItemUpdating"
		OnItemUpdated="ImageDetailsView_ItemUpdated"
...
<asp:HiddenField ID="hx_sold" Runat="server" Value='<%# Bind("sold") %>' />
			...
			<asp:TemplateField ShowHeader="False">
				...
				<asp:HiddenField id="x_ImageID" runat="server" />
				</EditItemTemplate>
			</asp:TemplateField>
		</Fields>
	</asp:DetailsView>
