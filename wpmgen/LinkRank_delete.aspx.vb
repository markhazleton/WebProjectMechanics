...
Partial Class LinkRank_delete
    ...
    user = CurrentUserName()
		...
		' LinkID Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "LinkID", keyvalue, RsSrc("LinkID"), newvalue)

		' UserID Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "UserID", keyvalue, RsSrc("UserID"), newvalue)

		' RankNum Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "RankNum", keyvalue, RsSrc("RankNum"), newvalue)

		' CateID Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "CateID", keyvalue, RsSrc("CateID"), newvalue)

		' Comment Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Comment", keyvalue, RsSrc("Comment"), newvalue)
	End Sub
