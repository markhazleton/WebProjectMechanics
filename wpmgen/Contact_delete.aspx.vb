...
Partial Class Contact_delete
	...
	Sub Page_Main()
		...
		For i As Integer = 0 to arRecKeys.GetUpperBound(0)
			...
			sFilter = sFilter & "[ContactID]=" & ew_AdjustSql(sKeyFld) & " AND "
    ...
    user = CurrentUserName()
		...
		' LogonName Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "LogonName", keyvalue, RsSrc("LogonName"), newvalue)

		' LogonPassword Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "LogonPassword", keyvalue, RsSrc("LogonPassword"), newvalue)

		' PrimaryContact Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "PrimaryContact", keyvalue, RsSrc("PrimaryContact"), newvalue)
		...
		' FirstName Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "FirstName", keyvalue, RsSrc("FirstName"), newvalue)

		' MiddleInitial Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "MiddleInitial", keyvalue, RsSrc("MiddleInitial"), newvalue)

		' LastName Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "LastName", keyvalue, RsSrc("LastName"), newvalue)

		' OfficePhone Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "OfficePhone", keyvalue, RsSrc("OfficePhone"), newvalue)

		' HomePhone Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "HomePhone", keyvalue, RsSrc("HomePhone"), newvalue)

		' MobilPhone Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "MobilPhone", keyvalue, RsSrc("MobilPhone"), newvalue)

		' Pager Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Pager", keyvalue, RsSrc("Pager"), newvalue)

		' URL Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "URL", keyvalue, RsSrc("URL"), newvalue)

		' Address1 Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Address1", keyvalue, RsSrc("Address1"), newvalue)

		' Address2 Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Address2", keyvalue, RsSrc("Address2"), newvalue)

		' City Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "City", keyvalue, RsSrc("City"), newvalue)

		' State Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "State", keyvalue, RsSrc("State"), newvalue)
		...
		' Biography Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Biography", keyvalue, "<MEMO>", newvalue)

		' CreateDT Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "CreateDT", keyvalue, RsSrc("CreateDT"), newvalue)

		' Paid Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "Paid", keyvalue, RsSrc("Paid"), newvalue)

		' email_subscribe Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "email_subscribe", keyvalue, RsSrc("email_subscribe"), newvalue)
	End Sub
