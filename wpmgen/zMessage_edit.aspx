<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="zMessage_edit.aspx.vb" Inherits="zMessage_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var zMessage_edit = new ew_Page("zMessage_edit");
// page properties
zMessage_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = zMessage_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
zMessage_edit.ValidateForm = function(fobj) {
...
zMessage_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
zMessage_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
<script type="text/javascript">
...
<p><span class="aspnetmaker">Edit TABLE: Message<br /><br />
<a href="<%= zMessage.ReturnUrl %>">Go Back</a></span></p>
<% zMessage_edit.ShowMessage() %>
<form name="fzMessageedit" id="fzMessageedit" method="post" onsubmit="this.action=location.pathname;return zMessage_edit.ValidateForm(this);">
<p />
<input type="hidden" name="a_table" id="a_table" value="zMessage" />
...
<% If zMessage.MessageID.Visible Then ' MessageID %>
	<tr<%= zMessage.MessageID.RowAttributes %>>
		...
		<td<%= zMessage.MessageID.CellAttributes %>><span id="el_MessageID">
<div<%= zMessage.MessageID.ViewAttributes %>><%= zMessage.MessageID.EditValue %></div>
<input type="hidden" name="x_MessageID" id="x_MessageID" value="<%= ew_HTMLEncode(zMessage.MessageID.CurrentValue) %>" />
</span><%= zMessage.MessageID.CustomMsg %></td>
	</tr>
<% End If %>
