...
Partial Class PageRole_view
	Inherits AspNetMaker7_WPMGen

	' Page object
	Public PageRole_view As cPageRole_view

	'
	' Page Class
	'
	Class cPageRole_view
		...
		Public Sub New(ByRef APage As AspNetMaker7_WPMGen)				
			...
			m_Page = Me	
			m_PageID = "view"
			m_PageObjName = "PageRole_view"
			m_PageObjTypeName = "cPageRole_view"
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			' Get action
			PageRole.CurrentAction = "I" ' Display form
			Select Case PageRole.CurrentAction
				Case "I" ' Get a record to display
					...
					Else ' Match key values
						Do While Rs.Read()
							If ew_SameStr(PageRole.PageRoleID.CurrentValue, Rs("PageRoleID")) Then
								PageRole.StartRecordNumber = lStartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
					...
					If Not bMatchRecord Then
						Message = "No records found" ' Set no record message
						sReturnUrl = "PageRole_list.aspx" ' No matching record, return to list
					Else
			...
			End Select
		Else
			sReturnUrl = "PageRole_list.aspx" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Page_Terminate(sReturnUrl)

		' Render row
		PageRole.RowType = EW_ROWTYPE_VIEW
		RenderRow()
	End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page init
		PageRole_view = New cPageRole_view(Me)		
		PageRole_view.Page_Init()

		' Page main processing
		PageRole_view.Page_Main()
	End Sub
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		If PageRole_view IsNot Nothing Then PageRole_view.Dispose()
	End Sub
End Class
