<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="CompanySiteParameter_edit.aspx.vb" Inherits="CompanySiteParameter_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var CompanySiteParameter_edit = new ew_Page("CompanySiteParameter_edit");
// page properties
CompanySiteParameter_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = CompanySiteParameter_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
CompanySiteParameter_edit.ValidateForm = function(fobj) {
...
CompanySiteParameter_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
CompanySiteParameter_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
...
<p><span class="aspnetmaker">Edit TABLE: Site Parameter<br /><br />
<a href="<%= CompanySiteParameter.ReturnUrl %>">Go Back</a></span></p>
<% CompanySiteParameter_edit.ShowMessage() %>
<form name="fCompanySiteParameteredit" id="fCompanySiteParameteredit" method="post">
<p />
<input type="hidden" name="a_table" id="a_table" value="CompanySiteParameter" />
...
<select id="x_CompanyID" name="x_CompanyID" onchange="ew_UpdateOpt('x_zPageID','x_CompanyID',CompanySiteParameter_edit.ar_x_zPageID);"<%= CompanySiteParameter.CompanyID.EditAttributes %>>
<%
emptywrk = True
...
<script type="text/javascript">
<!--
CompanySiteParameter_edit.ar_x_zPageID = [<%= jswrk %>];
//-->
</script>
...
<input type="hidden" name="x_CompanySiteParameterID" id="x_CompanySiteParameterID" value="<%= ew_HTMLEncode(CompanySiteParameter.CompanySiteParameterID.CurrentValue) %>" />
<p />
<input type="button" name="btnAction" id="btnAction" value="Save Changes" onclick="ew_SubmitForm(CompanySiteParameter_edit, this.form);" />
</form>
<script language="JavaScript">
<!--
ew_UpdateOpts([['x_zPageID','x_CompanyID',CompanySiteParameter_edit.ar_x_zPageID]]);
//-->
</script>
<script type="text/javascript">
<!--
