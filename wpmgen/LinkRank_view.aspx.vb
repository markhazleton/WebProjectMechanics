...
Partial Class LinkRank_view
	Inherits AspNetMaker7_WPMGen

	' Page object
	Public LinkRank_view As cLinkRank_view

	'
	' Page Class
	'
	Class cLinkRank_view
		...
		Public Sub New(ByRef APage As AspNetMaker7_WPMGen)				
			...
			m_Page = Me	
			m_PageID = "view"
			m_PageObjName = "LinkRank_view"
			m_PageObjTypeName = "cLinkRank_view"
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			' Get action
			LinkRank.CurrentAction = "I" ' Display form
			Select Case LinkRank.CurrentAction
				Case "I" ' Get a record to display
					...
					Else ' Match key values
						Do While Rs.Read()
							If ew_SameStr(LinkRank.ID.CurrentValue, Rs("ID")) Then
								LinkRank.StartRecordNumber = lStartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
					...
					If Not bMatchRecord Then
						Message = "No records found" ' Set no record message
						sReturnUrl = "LinkRank_list.aspx" ' No matching record, return to list
					Else
			...
			End Select
		Else
			sReturnUrl = "LinkRank_list.aspx" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Page_Terminate(sReturnUrl)

		' Render row
		LinkRank.RowType = EW_ROWTYPE_VIEW
		RenderRow()
	End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page init
		LinkRank_view = New cLinkRank_view(Me)		
		LinkRank_view.Page_Init()

		' Page main processing
		LinkRank_view.Page_Main()
	End Sub
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		If LinkRank_view IsNot Nothing Then LinkRank_view.Dispose()
	End Sub
End Class
