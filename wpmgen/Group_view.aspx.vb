...
Partial Class Group_view
	...
	' Page object
	Public Group_view As cGroup_view
	...
	Class cGroup_view
		...
		Public Sub New(ByRef APage As AspNetMaker7_WPMGen)				
			...
			m_Page = Me	
			m_PageID = "view"
			m_PageObjName = "Group_view"
			m_PageObjTypeName = "cGroup_view"
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			' Get action
			Group.CurrentAction = "I" ' Display form
			Select Case Group.CurrentAction
				Case "I" ' Get a record to display
					...
					Else ' Match key values
						Do While Rs.Read()
							If ew_SameStr(Group.GroupID.CurrentValue, Rs("GroupID")) Then
								Group.StartRecordNumber = lStartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
					...
					If Not bMatchRecord Then
						Message = "No records found" ' Set no record message
						sReturnUrl = "Group_list.aspx" ' No matching record, return to list
					Else
			...
			End Select
		Else
			sReturnUrl = "Group_list.aspx" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Page_Terminate(sReturnUrl)

		' Render row
		Group.RowType = EW_ROWTYPE_VIEW
		RenderRow()
	End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page init
		Group_view = New cGroup_view(Me)		
		Group_view.Page_Init()

		' Page main processing
		Group_view.Page_Main()
	End Sub
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		If Group_view IsNot Nothing Then Group_view.Dispose()
	End Sub
End Class
