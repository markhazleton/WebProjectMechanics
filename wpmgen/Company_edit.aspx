<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="Company_edit.aspx.vb" Inherits="Company_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Edit TABLE: Site<br /><br />
...
<% If Company.CompanyID.Visible Then ' CompanyID %>
	<tr<%= Company.CompanyID.RowAttributes %>>
		...
		<td<%= Company.CompanyID.CellAttributes %>><span id="el_CompanyID">
<div<%= Company.CompanyID.ViewAttributes %>><%= Company.CompanyID.EditValue %></div>
<input type="hidden" name="x_CompanyID" id="x_CompanyID" value="<%= ew_HTMLEncode(Company.CompanyID.CurrentValue) %>" />
</span><%= Company.CompanyID.CustomMsg %></td>
	</tr>
<% End If %>
