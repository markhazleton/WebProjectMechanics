<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="SiteTemplate_add.aspx.vb" Inherits="SiteTemplate_add" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Add to TABLE: Presentation Template (skin)<br /><br />
...
<input type="text" name="x_TemplatePrefix" id="x_TemplatePrefix" size="30" maxlength="10" value="<%= SiteTemplate.TemplatePrefix.EditValue %>"<%= SiteTemplate.TemplatePrefix.EditAttributes %> />
