...
Partial Class MissingPageImage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        wpmFileProcessing.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/MissingPageImage.text"), myContents)
    ...
    Private Function ProcessForm() As String
        ...
        If sPageID = String.Empty Then
            wpmLogging.AuditLog("No PageID Received", "MissingPageImage.ProcessForm")
            iPageID = 0
        Else
    ...
    Public Function ReviewImageCatalog() As Boolean
        ...
        For Each myRow As DataRow In dtPageImage.Rows
            ...
            If sNewImagePath <> String.Empty Then
                ' If wpmFileProcessing.MoveFile(HttpContext.Current.Server.MapPath(pageActiveSite.SiteGallery & wpmUTIL.GetDBString(myRow.Item("ImageFileName"))), sNewPagePath & "/" & wpmUTIL.GetDBString(myRow.Item("ImageFileName"))) Then
                wpmLogging.ErrorLog(sNewImagePath, sCurImagePath)
            End If
        Next
        Return True
    End Function
