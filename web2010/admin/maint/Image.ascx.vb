...
Public Class admin_maint_Image
    ...
    Public Const STR_INSERT_Image As String = "INSERT INTO [Image] ([ImageName], [ImageFileName], [ImageThumbFileName], [ImageDescription], [ImageComment], [ImageDate], [Active], [ModifiedDT], [VersionNo], [ContactID], [CompanyID], [title], [medium], [size], [price], [color], [subject], [sold]) VALUES (@ImageName, @ImageFileName, @ImageThumbFileName, @ImageDescription, @ImageComment, @ImageDate, @Active, @ModifiedDT, @VersionNo, @ContactID, @CompanyID, @title, @medium, @size, @price, @color, @subject, @sold)"
