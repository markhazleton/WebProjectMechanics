    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                Dim myListHeader As New DisplayTableHeader() With {.TableTitle = "Site Templates", .DetailKeyName = "TemplatePrefix", .DetailFieldName = "TemplatePrefix", .DetailPath = "/admin/maint/default.aspx?type=SiteTemplate&TemplatePrefix={0}"}
