            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <asp:Label ID="labelImageNameTextBox" runat="server" AssociatedControlID="ImageNameTextBox">ImageName:</asp:Label>
                            ...
                            <asp:Label ID="labelImageDescriptionTextBox" runat="server" AssociatedControlID="ImageDescriptionTextBox">ImageDescription:</asp:Label>
                            <asp:TextBox ID="ImageDescriptionTextBox" runat="server" Text="" CssClass="form-control" Rows="5" TextMode="MultiLine" />

                            <asp:Label ID="labelImageCommentTextBox" runat="server" AssociatedControlID="ImageCommentTextBox">ImageComment:</asp:Label>
                            <asp:TextBox ID="ImageCommentTextBox" runat="server" Text="" CssClass="form-control" />
                        </div>
                        <div class="col-lg-4">
