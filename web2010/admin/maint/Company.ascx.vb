...
Public Class admin_maint_Company
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                Next
                Dim myListHeader As New DisplayTableHeader() With {.TableTitle = "Site/Company", .DetailKeyName = "CompanyID", .DetailFieldName = "CompanyNM", .DetailPath = "/admin/maint/default.aspx?type=Company&CompanyID={0}"}
                myListHeader.HeaderItems.Add(New DisplayTableHeaderItem With {.Name = "SiteGallery", .Value = "SiteGallery"})
                myListHeader.HeaderItems.Add(New DisplayTableHeaderItem With {.Name = "SiteCategoryTypeNM",
                                                                              .Value = "SiteCategoryTypeNM",
                                                                              .KeyField = True,
                                                                              .LinkPath = "/admin/maint/default.aspx?type=SiteType&SiteTypeID={0}",
                                                                              .LinkTextName = "SiteCategoryTypeNM",
                                                                              .LinkKeyName = "SiteCategoryTypeID"})
        ...
        If IsNumeric(myCompanyID) AndAlso CInt(myCompanyID) > 0 Then
            For Each myRow In wpm_GetDataTable(String.Format(STR_SELECT_CompanyByCompanyID, myCompanyID), "Company").Rows
                ...
                With myCompany
                    ...
                    DefaultPaymentTermsTextBox.Text = .CompanyKeywords
                    DefaultArticleIDDropDown.SelectedValue = .DefaultArticleID
                    DefaultInvoiceDescriptionTextBox.Text = .CompanyDescription
                    ...
                    FromEmailTextBox.Text = .FromEmail
                    SMTPTextBox.Text = .SMTP
                    ComponentTextBox.Text = .Component
                    SiteCategoryTypeIDTextBox.Text = .SiteCategoryTypeID
                    ActiveFLCheckBox.Checked = True
                    SingleSiteGalleryCheckBox.Checked = True
                End With
            Next
            myCompany.Articles.PopulateCompanyArticleList(myCompanyID)
            wpm_LoadArticleDropDown(DefaultArticleIDDropDown, myCompany.DefaultArticleID, myCompany.Articles, False)
    ...
    Private Function GetCompanyForUpdate() As Company
        ...
        With myCompany
            ...
            .CompanyKeywords = DefaultPaymentTermsTextBox.Text
            .CompanyDescription = DefaultInvoiceDescriptionTextBox.Text
            ...
            .FromEmail = FromEmailTextBox.Text
            .SMTP = SMTPTextBox.Text
            .Component = ComponentTextBox.Text
            .SiteCategoryTypeID = SiteCategoryTypeIDTextBox.Text
            ' = ActiveFLCheckBox.Checked 
            ' = SingleSiteGalleryCheckBox.Checked 
        End With
        Return myCompany
    End Function
            ...
            Using conn As New OleDbConnection(wpm_SQLDBConnString)
                Try
                    ...
                    Using cmd As New OleDbCommand() With {.Connection = conn, .CommandType = CommandType.Text, .CommandText = STR_UPDATE_Company}
                        ...
                        wpm_AddParameterStringValue("@DefaultPaymentTerms", DefaultPaymentTermsTextBox.Text, cmd)
                        wpm_AddParameterStringValue("@DefaultInvoiceDescription", DefaultInvoiceDescriptionTextBox.Text, cmd)
                        ...
                        wpm_AddParameterValue("@SiteCategoryTypeID", .SiteCategoryTypeID, SqlDbType.Int, cmd)
