...
Public Partial Class AspNetMaker8_wpmWebsite
	...
	Class cLinkType
		...
		Public Function Insert(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "INSERT INTO [LinkType] (" & names & ") VALUES (" & values & ")"
		...
		Public Function Update(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "UPDATE [LinkType] SET " & values
		...
		Public Function Delete(ByRef Rs As OrderedDictionary) As Integer
			Dim Sql As String
			Dim fld As cField			
			Sql = "DELETE FROM [LinkType] WHERE "
			fld = FieldByName("LinkTypeCD")
			Sql = Sql & fld.FldExpression & "=" & ew_QuotedValue(Rs("LinkTypeCD"), EW_DATATYPE_STRING) & " AND "
		...
		Public ReadOnly Property KeyFilter() As String
			Get
				...
				sKeyFilter = sKeyFilter.Replace("@LinkTypeCD@", ew_AdjustSql(LinkTypeCD.CurrentValue)) ' Replace key value
				Return sKeyFilter
			End Get
		End Property
		...
		Public Function ViewUrl() As String
			Return KeyUrl("linktype_view.aspx", UrlParm(""))
		End Function

		' Add URL
		Public Function AddUrl() As String
			AddUrl = "linktype_add.aspx"
		...
		Public Function EditUrl() As String
			Return KeyUrl("linktype_edit.aspx", UrlParm(""))
		End Function
		...
		Public Function CopyUrl() As String
			Return KeyUrl("linktype_add.aspx", UrlParm(""))
		End Function
		...
		Public Function DeleteUrl() As String
			Return KeyUrl("linktype_delete.aspx", UrlParm(""))
		End Function
		...
		Public Function KeyUrl(url As String, parm As String) As String
			...
			If Not IsDbNull(LinkTypeCD.CurrentValue) Then
				sUrl = sUrl & "LinkTypeCD=" & HttpContext.Current.Server.UrlEncode(Convert.ToString(LinkTypeCD.CurrentValue))
			Else
		...
		Public Sub LoadListRowValues(ByRef RsRow As OleDbDataReader)			
			...
			LinkTypeDesc.DbValue = RsRow("LinkTypeDesc")
			LinkTypeComment.DbValue = RsRow("LinkTypeComment")
			LinkTypeTarget.DbValue = RsRow("LinkTypeTarget")
		End Sub
		...
		'
			...
			' LinkTypeDesc
			LinkTypeDesc.CellCssStyle = ""
			LinkTypeDesc.CellCssClass = ""
			LinkTypeDesc.CellAttrs.Clear(): LinkTypeDesc.ViewAttrs.Clear(): LinkTypeDesc.EditAttrs.Clear()

			' LinkTypeTarget
			LinkTypeTarget.CellCssStyle = ""
			LinkTypeTarget.CellCssClass = ""
			LinkTypeTarget.CellAttrs.Clear(): LinkTypeTarget.ViewAttrs.Clear(): LinkTypeTarget.EditAttrs.Clear()
		...
		'
			...
			' LinkTypeDesc
			LinkTypeDesc.ViewValue = LinkTypeDesc.CurrentValue
			LinkTypeDesc.CssStyle = ""
			LinkTypeDesc.CssClass = ""
			LinkTypeDesc.ViewCustomAttributes = ""

			' LinkTypeTarget
			LinkTypeTarget.ViewValue = LinkTypeTarget.CurrentValue
			LinkTypeTarget.CssStyle = ""
			LinkTypeTarget.CssClass = ""
			LinkTypeTarget.ViewCustomAttributes = ""
		...
		'
			...
			' LinkTypeDesc
			LinkTypeDesc.HrefValue = ""
			LinkTypeDesc.TooltipValue = ""

			' LinkTypeTarget
			LinkTypeTarget.HrefValue = ""
			LinkTypeTarget.TooltipValue = ""
		...
		Public Function FieldByName(Name As String) As Object
			...
			If Name = "LinkTypeDesc" Then Return LinkTypeDesc
			If Name = "LinkTypeComment" Then Return LinkTypeComment
			If Name = "LinkTypeTarget" Then Return LinkTypeTarget
			Return Nothing		
		End Function
		...
		Public ReadOnly Property LinkTypeCD() As cField
			Get
				If m_LinkTypeCD Is Nothing Then
					m_LinkTypeCD = New cField(m_Page, "LinkType", "LinkType", "x_LinkTypeCD", "LinkTypeCD", "[LinkTypeCD]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_LinkTypeCD
			End Get
		End Property
		...
		' LinkTypeDesc
		Private m_LinkTypeDesc As cField

		Public ReadOnly Property LinkTypeDesc() As cField
			Get
				If m_LinkTypeDesc Is Nothing Then
					m_LinkTypeDesc = New cField(m_Page, "LinkType", "LinkType", "x_LinkTypeDesc", "LinkTypeDesc", "[LinkTypeDesc]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_LinkTypeDesc
			End Get
		End Property

		' LinkTypeComment
		Private m_LinkTypeComment As cField

		Public ReadOnly Property LinkTypeComment() As cField
			Get
				If m_LinkTypeComment Is Nothing Then
					m_LinkTypeComment = New cField(m_Page, "LinkType", "LinkType", "x_LinkTypeComment", "LinkTypeComment", "[LinkTypeComment]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
				End If
				Return m_LinkTypeComment
			End Get
		End Property

		' LinkTypeTarget
		Private m_LinkTypeTarget As cField

		Public ReadOnly Property LinkTypeTarget() As cField
			Get
				If m_LinkTypeTarget Is Nothing Then
					m_LinkTypeTarget = New cField(m_Page, "LinkType", "LinkType", "x_LinkTypeTarget", "LinkTypeTarget", "[LinkTypeTarget]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_LinkTypeTarget
			End Get
		End Property
		...
		Public Sub Dispose() Implements IDisposable.Dispose
			...
			If m_LinkTypeDesc IsNot Nothing Then m_LinkTypeDesc.Dispose()
			If m_LinkTypeComment IsNot Nothing Then m_LinkTypeComment.Dispose()
			If m_LinkTypeTarget IsNot Nothing Then m_LinkTypeTarget.Dispose()
		End Sub
	End Class
End Class
