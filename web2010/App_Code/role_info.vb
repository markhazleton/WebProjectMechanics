...
Public Partial Class AspNetMaker8_wpmWebsite
	...
	Class crole
		...
		'
			...
			' RoleName
			RoleName.CellCssStyle = ""
			RoleName.CellCssClass = ""
			RoleName.CellAttrs.Clear(): RoleName.ViewAttrs.Clear(): RoleName.EditAttrs.Clear()

			' RoleTitle
			RoleTitle.CellCssStyle = ""
			RoleTitle.CellCssClass = ""
			RoleTitle.CellAttrs.Clear(): RoleTitle.ViewAttrs.Clear(): RoleTitle.EditAttrs.Clear()

			' RoleComment
			RoleComment.CellCssStyle = ""
			RoleComment.CellCssClass = ""
			RoleComment.CellAttrs.Clear(): RoleComment.ViewAttrs.Clear(): RoleComment.EditAttrs.Clear()

			' FilterMenu
			FilterMenu.CellCssStyle = ""
			FilterMenu.CellCssClass = ""
			FilterMenu.CellAttrs.Clear(): FilterMenu.ViewAttrs.Clear(): FilterMenu.EditAttrs.Clear()
		...
		'
			...
			' RoleName
			RoleName.HrefValue = ""
			RoleName.TooltipValue = ""

			' RoleTitle
			RoleTitle.HrefValue = ""
			RoleTitle.TooltipValue = ""

			' RoleComment
			RoleComment.HrefValue = ""
			RoleComment.TooltipValue = ""

			' FilterMenu
			FilterMenu.HrefValue = ""
			FilterMenu.TooltipValue = ""
		...
		Public ReadOnly Property RoleID() As cField
			Get
				If m_RoleID Is Nothing Then
					m_RoleID = New cField(m_Page, "role", "role", "x_RoleID", "RoleID", "[RoleID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property RoleName() As cField
			Get
				If m_RoleName Is Nothing Then
					m_RoleName = New cField(m_Page, "role", "role", "x_RoleName", "RoleName", "[RoleName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_RoleName
			End Get
		End Property
		...
		Public ReadOnly Property RoleTitle() As cField
			Get
				If m_RoleTitle Is Nothing Then
					m_RoleTitle = New cField(m_Page, "role", "role", "x_RoleTitle", "RoleTitle", "[RoleTitle]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_RoleTitle
			End Get
		End Property
		...
		Public ReadOnly Property RoleComment() As cField
			Get
				If m_RoleComment Is Nothing Then
					m_RoleComment = New cField(m_Page, "role", "role", "x_RoleComment", "RoleComment", "[RoleComment]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
		...
		Public ReadOnly Property FilterMenu() As cField
			Get
				If m_FilterMenu Is Nothing Then
					m_FilterMenu = New cField(m_Page, "role", "role", "x_FilterMenu", "FilterMenu", "[FilterMenu]", 11, OleDbType.Boolean, EW_DATATYPE_BOOLEAN,  0)
				End If
				Return m_FilterMenu
			End Get
		End Property
