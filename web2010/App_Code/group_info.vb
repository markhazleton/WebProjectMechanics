...
Public Partial Class AspNetMaker8_wpmWebsite
	...
	Class cGroup
		...
		Public Function Insert(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "INSERT INTO [Group] (" & names & ") VALUES (" & values & ")"
		...
		Public Function Delete(ByRef Rs As OrderedDictionary) As Integer
			...
			fld = FieldByName("GroupID")
			Sql = Sql & fld.FldExpression & "=" & ew_QuotedValue(Rs("GroupID"), EW_DATATYPE_NUMBER) & " AND "
		...
		Public ReadOnly Property KeyFilter() As String
			Get
				...
				If Not IsNumeric(GroupID.CurrentValue) Then
					sKeyFilter = "0=1" ' Invalid key
				End If
				sKeyFilter = sKeyFilter.Replace("@GroupID@", ew_AdjustSql(GroupID.CurrentValue)) ' Replace key value
				Return sKeyFilter
			End Get
		End Property
		...
		Public Function ViewUrl() As String
			Return KeyUrl("group_view.aspx", UrlParm(""))
		End Function

		' Add URL
		Public Function AddUrl() As String
			AddUrl = "group_add.aspx"
		...
		Public Function EditUrl() As String
			Return KeyUrl("group_edit.aspx", UrlParm(""))
		End Function
		...
		Public Function CopyUrl() As String
			Return KeyUrl("group_add.aspx", UrlParm(""))
		End Function
		...
		Public Function DeleteUrl() As String
			Return KeyUrl("group_delete.aspx", UrlParm(""))
		End Function
		...
		Public Function KeyUrl(url As String, parm As String) As String
			...
			If Not IsDbNull(GroupID.CurrentValue) Then
				sUrl = sUrl & "GroupID=" & GroupID.CurrentValue
			Else
		...
		Public Sub LoadListRowValues(ByRef RsRow As OleDbDataReader)			
			...
			GroupName.DbValue = RsRow("GroupName")
			GroupComment.DbValue = RsRow("GroupComment")
		End Sub
		...
		'
			...
			GroupName.CellCssStyle = ""
			GroupName.CellCssClass = ""
			GroupName.CellAttrs.Clear(): GroupName.ViewAttrs.Clear(): GroupName.EditAttrs.Clear()

			' GroupComment
			GroupComment.CellCssStyle = ""
			GroupComment.CellCssClass = ""
			GroupComment.CellAttrs.Clear(): GroupComment.ViewAttrs.Clear(): GroupComment.EditAttrs.Clear()
		...
		'
			...
			GroupName.ViewValue = GroupName.CurrentValue
			GroupName.CssStyle = ""
			GroupName.CssClass = ""
			GroupName.ViewCustomAttributes = ""

			' GroupComment
			GroupComment.ViewValue = GroupComment.CurrentValue
			GroupComment.CssStyle = ""
			GroupComment.CssClass = ""
			GroupComment.ViewCustomAttributes = ""
		...
		'
			...
			GroupName.HrefValue = ""
			GroupName.TooltipValue = ""

			' GroupComment
			GroupComment.HrefValue = ""
			GroupComment.TooltipValue = ""
		...
		Public Function FieldByName(Name As String) As Object
			...
			If Name = "GroupName" Then Return GroupName
			If Name = "GroupComment" Then Return GroupComment
			Return Nothing		
		End Function
		...
		Public ReadOnly Property GroupID() As cField
			Get
				If m_GroupID Is Nothing Then
					m_GroupID = New cField(m_Page, "Group", "Group", "x_GroupID", "GroupID", "[GroupID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		' GroupName
		Private m_GroupName As cField

		Public ReadOnly Property GroupName() As cField
			Get
				If m_GroupName Is Nothing Then
					m_GroupName = New cField(m_Page, "Group", "Group", "x_GroupName", "GroupName", "[GroupName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_GroupName
			End Get
		End Property
		...
		' GroupComment
		Private m_GroupComment As cField

		Public ReadOnly Property GroupComment() As cField
			Get
				If m_GroupComment Is Nothing Then
					m_GroupComment = New cField(m_Page, "Group", "Group", "x_GroupComment", "GroupComment", "[GroupComment]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
		...
		Public Sub Dispose() Implements IDisposable.Dispose
			...
			If m_GroupName IsNot Nothing Then m_GroupName.Dispose()
			If m_GroupComment IsNot Nothing Then m_GroupComment.Dispose()
		End Sub
	End Class
End Class
