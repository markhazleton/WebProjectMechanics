...
Public Partial Class AspNetMaker8_wpmWebsite
	...
	Public SiteCategoryType As cSiteCategoryType

	' Define table class
	Class cSiteCategoryType
		...
		Public ReadOnly Property HighlightName() As String
			Get
				Return "SiteCategoryType_Highlight"
			End Get
		End Property
		...
		Public ReadOnly Property SqlSelect() As String
			Get ' Select
				Return "SELECT * FROM [SiteCategoryType]"
			End Get
		End Property
		...
		Public Function Insert(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "INSERT INTO [SiteCategoryType] (" & names & ") VALUES (" & values & ")"
		...
		Public Function Update(ByRef Rs As OrderedDictionary) As Integer
			...
			Sql = "UPDATE [SiteCategoryType] SET " & values
		...
		Public Function Delete(ByRef Rs As OrderedDictionary) As Integer
			Dim Sql As String
			Dim fld As cField			
			Sql = "DELETE FROM [SiteCategoryType] WHERE "
			fld = FieldByName("SiteCategoryTypeID")
			Sql = Sql & fld.FldExpression & "=" & ew_QuotedValue(Rs("SiteCategoryTypeID"), EW_DATATYPE_NUMBER) & " AND "
		...
		Private ReadOnly Property SqlKeyFilter() As String
			Get
				Return "[SiteCategoryTypeID] = @SiteCategoryTypeID@"
			End Get
		End Property
		...
		Public ReadOnly Property KeyFilter() As String
			Get
				...
				If Not IsNumeric(SiteCategoryTypeID.CurrentValue) Then
					sKeyFilter = "0=1" ' Invalid key
				End If
				sKeyFilter = sKeyFilter.Replace("@SiteCategoryTypeID@", ew_AdjustSql(SiteCategoryTypeID.CurrentValue)) ' Replace key value
				Return sKeyFilter
			End Get
		End Property
		...
		Public ReadOnly Property ReturnUrl() As String
			Get ' Get referer URL automatically
				...
				Else
					Return "sitecategorytype_list.aspx"
				End If
			End Get
		End Property
		...
		Public Function ViewUrl() As String
			Return KeyUrl("sitecategorytype_view.aspx", UrlParm(""))
		End Function

		' Add URL
		Public Function AddUrl() As String
			AddUrl = "sitecategorytype_add.aspx"
		...
		Public Function EditUrl() As String
			Return KeyUrl("sitecategorytype_edit.aspx", UrlParm(""))
		End Function
		...
		Public Function CopyUrl() As String
			Return KeyUrl("sitecategorytype_add.aspx", UrlParm(""))
		End Function
		...
		Public Function DeleteUrl() As String
			Return KeyUrl("sitecategorytype_delete.aspx", UrlParm(""))
		End Function
		...
		Public Function KeyUrl(url As String, parm As String) As String
			...
			If Not IsDbNull(SiteCategoryTypeID.CurrentValue) Then
				sUrl = sUrl & "SiteCategoryTypeID=" & SiteCategoryTypeID.CurrentValue
			Else
		...
		Public Sub LoadListRowValues(ByRef RsRow As OleDbDataReader)			
			...
			SiteCategoryTypeNM.DbValue = RsRow("SiteCategoryTypeNM")
			SiteCategoryTypeDS.DbValue = RsRow("SiteCategoryTypeDS")
			SiteCategoryComment.DbValue = RsRow("SiteCategoryComment")
			SiteCategoryFileName.DbValue = RsRow("SiteCategoryFileName")
			SiteCategoryTransferURL.DbValue = RsRow("SiteCategoryTransferURL")
			DefaultSiteCategoryID.DbValue = RsRow("DefaultSiteCategoryID")
		End Sub
		...
		'
			...
			' SiteCategoryTypeNM
			SiteCategoryTypeNM.CellCssStyle = ""
			SiteCategoryTypeNM.CellCssClass = ""
			SiteCategoryTypeNM.CellAttrs.Clear(): SiteCategoryTypeNM.ViewAttrs.Clear(): SiteCategoryTypeNM.EditAttrs.Clear()

			' SiteCategoryTypeDS
			SiteCategoryTypeDS.CellCssStyle = ""
			SiteCategoryTypeDS.CellCssClass = ""
			SiteCategoryTypeDS.CellAttrs.Clear(): SiteCategoryTypeDS.ViewAttrs.Clear(): SiteCategoryTypeDS.EditAttrs.Clear()

			' SiteCategoryComment
			SiteCategoryComment.CellCssStyle = ""
			SiteCategoryComment.CellCssClass = ""
			SiteCategoryComment.CellAttrs.Clear(): SiteCategoryComment.ViewAttrs.Clear(): SiteCategoryComment.EditAttrs.Clear()

			' SiteCategoryFileName
			SiteCategoryFileName.CellCssStyle = ""
			SiteCategoryFileName.CellCssClass = ""
			SiteCategoryFileName.CellAttrs.Clear(): SiteCategoryFileName.ViewAttrs.Clear(): SiteCategoryFileName.EditAttrs.Clear()

			' SiteCategoryTransferURL
			SiteCategoryTransferURL.CellCssStyle = ""
			SiteCategoryTransferURL.CellCssClass = ""
			SiteCategoryTransferURL.CellAttrs.Clear(): SiteCategoryTransferURL.ViewAttrs.Clear(): SiteCategoryTransferURL.EditAttrs.Clear()

			' DefaultSiteCategoryID
			DefaultSiteCategoryID.CellCssStyle = ""
			DefaultSiteCategoryID.CellCssClass = ""
			DefaultSiteCategoryID.CellAttrs.Clear(): DefaultSiteCategoryID.ViewAttrs.Clear(): DefaultSiteCategoryID.EditAttrs.Clear()
		...
		'
			...
			' SiteCategoryTypeNM
			SiteCategoryTypeNM.ViewValue = SiteCategoryTypeNM.CurrentValue
			SiteCategoryTypeNM.CssStyle = ""
			SiteCategoryTypeNM.CssClass = ""
			SiteCategoryTypeNM.ViewCustomAttributes = ""

			' SiteCategoryTypeDS
			SiteCategoryTypeDS.ViewValue = SiteCategoryTypeDS.CurrentValue
			SiteCategoryTypeDS.CssStyle = ""
			SiteCategoryTypeDS.CssClass = ""
			SiteCategoryTypeDS.ViewCustomAttributes = ""

			' SiteCategoryComment
			SiteCategoryComment.ViewValue = SiteCategoryComment.CurrentValue
			SiteCategoryComment.CssStyle = ""
			SiteCategoryComment.CssClass = ""
			SiteCategoryComment.ViewCustomAttributes = ""

			' SiteCategoryFileName
			SiteCategoryFileName.ViewValue = SiteCategoryFileName.CurrentValue
			SiteCategoryFileName.CssStyle = ""
			SiteCategoryFileName.CssClass = ""
			SiteCategoryFileName.ViewCustomAttributes = ""

			' SiteCategoryTransferURL
			SiteCategoryTransferURL.ViewValue = SiteCategoryTransferURL.CurrentValue
			SiteCategoryTransferURL.CssStyle = ""
			SiteCategoryTransferURL.CssClass = ""
			SiteCategoryTransferURL.ViewCustomAttributes = ""

			' DefaultSiteCategoryID
			DefaultSiteCategoryID.ViewValue = DefaultSiteCategoryID.CurrentValue
			DefaultSiteCategoryID.CssStyle = ""
			DefaultSiteCategoryID.CssClass = ""
			DefaultSiteCategoryID.ViewCustomAttributes = ""
		...
		'
			...
			' SiteCategoryTypeNM
			SiteCategoryTypeNM.HrefValue = ""
			SiteCategoryTypeNM.TooltipValue = ""

			' SiteCategoryTypeDS
			SiteCategoryTypeDS.HrefValue = ""
			SiteCategoryTypeDS.TooltipValue = ""

			' SiteCategoryComment
			SiteCategoryComment.HrefValue = ""
			SiteCategoryComment.TooltipValue = ""

			' SiteCategoryFileName
			SiteCategoryFileName.HrefValue = ""
			SiteCategoryFileName.TooltipValue = ""

			' SiteCategoryTransferURL
			SiteCategoryTransferURL.HrefValue = ""
			SiteCategoryTransferURL.TooltipValue = ""

			' DefaultSiteCategoryID
			DefaultSiteCategoryID.HrefValue = ""
			DefaultSiteCategoryID.TooltipValue = ""
		...
		Public Function FieldByName(Name As String) As Object
			...
			If Name = "SiteCategoryTypeNM" Then Return SiteCategoryTypeNM
			If Name = "SiteCategoryTypeDS" Then Return SiteCategoryTypeDS
			If Name = "SiteCategoryComment" Then Return SiteCategoryComment
			If Name = "SiteCategoryFileName" Then Return SiteCategoryFileName
			If Name = "SiteCategoryTransferURL" Then Return SiteCategoryTransferURL
			If Name = "DefaultSiteCategoryID" Then Return DefaultSiteCategoryID
			Return Nothing		
		End Function
		...
		Public ReadOnly Property SiteCategoryTypeID() As cField
			Get
				If m_SiteCategoryTypeID Is Nothing Then
					m_SiteCategoryTypeID = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryTypeID", "SiteCategoryTypeID", "[SiteCategoryTypeID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		' SiteCategoryTypeNM
		Private m_SiteCategoryTypeNM As cField

		Public ReadOnly Property SiteCategoryTypeNM() As cField
			Get
				If m_SiteCategoryTypeNM Is Nothing Then
					m_SiteCategoryTypeNM = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryTypeNM", "SiteCategoryTypeNM", "[SiteCategoryTypeNM]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_SiteCategoryTypeNM
			End Get
		End Property

		' SiteCategoryTypeDS
		Private m_SiteCategoryTypeDS As cField

		Public ReadOnly Property SiteCategoryTypeDS() As cField
			Get
				If m_SiteCategoryTypeDS Is Nothing Then
					m_SiteCategoryTypeDS = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryTypeDS", "SiteCategoryTypeDS", "[SiteCategoryTypeDS]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_SiteCategoryTypeDS
			End Get
		End Property

		' SiteCategoryComment
		Private m_SiteCategoryComment As cField

		Public ReadOnly Property SiteCategoryComment() As cField
			Get
				If m_SiteCategoryComment Is Nothing Then
					m_SiteCategoryComment = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryComment", "SiteCategoryComment", "[SiteCategoryComment]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_SiteCategoryComment
			End Get
		End Property

		' SiteCategoryFileName
		Private m_SiteCategoryFileName As cField

		Public ReadOnly Property SiteCategoryFileName() As cField
			Get
				If m_SiteCategoryFileName Is Nothing Then
					m_SiteCategoryFileName = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryFileName", "SiteCategoryFileName", "[SiteCategoryFileName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_SiteCategoryFileName
			End Get
		End Property

		' SiteCategoryTransferURL
		Private m_SiteCategoryTransferURL As cField

		Public ReadOnly Property SiteCategoryTransferURL() As cField
			Get
				If m_SiteCategoryTransferURL Is Nothing Then
					m_SiteCategoryTransferURL = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_SiteCategoryTransferURL", "SiteCategoryTransferURL", "[SiteCategoryTransferURL]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				End If
				Return m_SiteCategoryTransferURL
			End Get
		End Property

		' DefaultSiteCategoryID
		Private m_DefaultSiteCategoryID As cField

		Public ReadOnly Property DefaultSiteCategoryID() As cField
			Get
				If m_DefaultSiteCategoryID Is Nothing Then
					m_DefaultSiteCategoryID = New cField(m_Page, "SiteCategoryType", "SiteCategoryType", "x_DefaultSiteCategoryID", "DefaultSiteCategoryID", "[DefaultSiteCategoryID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
					m_DefaultSiteCategoryID.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
				End If
				Return m_DefaultSiteCategoryID
			End Get
		End Property
		...
		Public Sub Dispose() Implements IDisposable.Dispose
			...
			If m_SiteCategoryTypeNM IsNot Nothing Then m_SiteCategoryTypeNM.Dispose()
			If m_SiteCategoryTypeDS IsNot Nothing Then m_SiteCategoryTypeDS.Dispose()
			If m_SiteCategoryComment IsNot Nothing Then m_SiteCategoryComment.Dispose()
			If m_SiteCategoryFileName IsNot Nothing Then m_SiteCategoryFileName.Dispose()
			If m_SiteCategoryTransferURL IsNot Nothing Then m_SiteCategoryTransferURL.Dispose()
			If m_DefaultSiteCategoryID IsNot Nothing Then m_DefaultSiteCategoryID.Dispose()
		End Sub
	End Class
End Class
