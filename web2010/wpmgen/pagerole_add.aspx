<%@ Page ClassName="pagerole_add" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="pagerole_add.aspx.vb" Inherits="pagerole_add" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
PageRole_add.FormID = "fPageRoleadd"; // form ID 
...
PageRole_add.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= PageRole.TableCaption %><br /><br />
<a href="<%= PageRole.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(PageRole_add.DebugMsg) %>
