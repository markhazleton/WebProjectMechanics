<%@ Page ClassName="linkrank_edit" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="linkrank_edit.aspx.vb" Inherits="linkrank_edit" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
LinkRank_edit.FormID = "fLinkRankedit"; // form ID 
...
LinkRank_edit.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= LinkRank.TableCaption %><br /><br />
<a href="<%= LinkRank.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(LinkRank_edit.DebugMsg) %>
