<%@ Page ClassName="pageimage_edit" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="pageimage_edit.aspx.vb" Inherits="pageimage_edit" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
PageImage_edit.FormID = "fPageImageedit"; // form ID 
...
PageImage_edit.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= PageImage.TableCaption %><br /><br />
<a href="<%= PageImage.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(PageImage_edit.DebugMsg) %>
