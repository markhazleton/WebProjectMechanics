...
Partial Class linktype_edit
	...
	Class cLinkType_edit
		...
		' ASP.NET page object
		Public ReadOnly Property AspNetPage() As linktype_edit
			Get
				Return CType(m_ParentPage, linktype_edit)
			End Get
		End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit") <> "" Then
			...
			If Not ValidateForm() Then
				...
				LinkType.EventCancelled = True ' Event cancelled
				LoadRow() ' Restore row
	...
	Function EditRow() As Boolean
		...
		If LinkType.LinkTypeCD.CurrentValue <> "" Then ' Check field with unique index
			...
			Try
				...
				If RsChk.Read() Then
					sIdxErrMsg = Language.Phrase("DupIndex").Replace("%f", "LinkTypeCD")
