<%@ Page ClassName="sitelink_add" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="sitelink_add.aspx.vb" Inherits="sitelink_add" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
SiteLink_add.FormID = "fSiteLinkadd"; // form ID 
...
SiteLink_add.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= SiteLink.TableCaption %><br /><br />
<a href="<%= SiteLink.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(SiteLink_add.DebugMsg) %>
<% SiteLink_add.ShowMessage() %>
<form name="fSiteLinkadd" id="fSiteLinkadd" method="post" onsubmit="this.action=location.pathname;return SiteLink_add.ValidateForm(this);">
<p />
