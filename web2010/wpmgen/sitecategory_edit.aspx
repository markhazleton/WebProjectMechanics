<%@ Page ClassName="sitecategory_edit" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="sitecategory_edit.aspx.vb" Inherits="sitecategory_edit" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var SiteCategory_edit = new ew_Page("SiteCategory_edit");
// page properties
SiteCategory_edit.PageID = "edit"; // page ID
SiteCategory_edit.FormID = "fSiteCategoryedit"; // form ID 
var EW_PAGE_ID = SiteCategory_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
SiteCategory_edit.ValidateForm = function(fobj) {
...
SiteCategory_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!
 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
<% If EW_CLIENT_VALIDATE Then %>
SiteCategory_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
SiteCategory_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
<script type="text/javascript">
...
<p><span class="aspnetmaker"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= SiteCategory.TableCaption %><br /><br />
<a href="<%= SiteCategory.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(SiteCategory_edit.DebugMsg) %>
<% SiteCategory_edit.ShowMessage() %>
<form name="fSiteCategoryedit" id="fSiteCategoryedit" method="post" onsubmit="this.action=location.pathname;return SiteCategory_edit.ValidateForm(this);">
<p />
<input type="hidden" name="a_table" id="a_table" value="SiteCategory" />
...
<% If SiteCategory.SiteCategoryID.Visible Then ' SiteCategoryID %>
	<tr<%= SiteCategory.RowAttributes %>>
		...
		<td<%= SiteCategory.SiteCategoryID.CellAttributes %>><span id="el_SiteCategoryID">
<div<%= SiteCategory.SiteCategoryID.ViewAttributes %>><%= SiteCategory.SiteCategoryID.EditValue %></div>
<input type="hidden" name="x_SiteCategoryID" id="x_SiteCategoryID" value="<%= ew_HTMLEncode(SiteCategory.SiteCategoryID.CurrentValue) %>" />
</span><%= SiteCategory.SiteCategoryID.CustomMsg %></td>
	</tr>
<% End If %>
