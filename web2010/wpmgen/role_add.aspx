<%@ Page ClassName="role_add" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="role_add.aspx.vb" Inherits="role_add" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
role_add.FormID = "froleadd"; // form ID 
...
<p><span class="aspnetmaker"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= role.TableCaption %><br /><br />
<a href="<%= role.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(role_add.DebugMsg) %>
