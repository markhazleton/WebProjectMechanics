...
Partial Class article_edit
	...
	Class cArticle_edit
		...
		' ASP.NET page object
		Public ReadOnly Property AspNetPage() As article_edit
			Get
				Return CType(m_ParentPage, article_edit)
			End Get
		End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit") <> "" Then
			...
			If Not ValidateForm() Then
				...
				Article.EventCancelled = True ' Event cancelled
				LoadRow() ' Restore row
	...
	Function EditRow() As Boolean
		...
		Else
			Try
				...
				' Active
				Article.Active.SetDbValue(Rs, (Article.Active.CurrentValue <> "" AndAlso Not IsDBNull(Article.Active.CurrentValue)), System.DBNull.Value, False)
				...
				' CompanyID
				Article.CompanyID.SetDbValue(Rs, Article.CompanyID.CurrentValue, System.DBNull.Value, False)

				' PageID
				Article.zPageID.SetDbValue(Rs, Article.zPageID.CurrentValue, System.DBNull.Value, False)

				' userID
				Article.userID.SetDbValue(Rs, Article.userID.CurrentValue, System.DBNull.Value, False)
				...
				' Counter
				Article.Counter.SetDbValue(Rs, Article.Counter.CurrentValue, System.DBNull.Value, False)

				' VersionNo
				Article.VersionNo.SetDbValue(Rs, Article.VersionNo.CurrentValue, System.DBNull.Value, False)

				' ContactID
				Article.ContactID.SetDbValue(Rs, Article.ContactID.CurrentValue, System.DBNull.Value, False)
