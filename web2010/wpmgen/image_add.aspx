<%@ Page ClassName="image_add" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="image_add.aspx.vb" Inherits="image_add" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
Image_add.FormID = "fImageadd"; // form ID 
...
<p><span class="aspnetmaker"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= Image.TableCaption %><br /><br />
<a href="<%= Image.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(Image_add.DebugMsg) %>
