...
Partial Class image_add
	...
	Class cImage_add
		...
		' ASP.NET page object
		Public ReadOnly Property AspNetPage() As image_add
			Get
				Return CType(m_ParentPage, image_add)
			End Get
		End Property
	...
	Function AddRow() As Boolean
		...
		Try
			...
			' VersionNo
			Image.VersionNo.SetDbValue(Rs, Image.VersionNo.CurrentValue, System.DBNull.Value, True)

			' ContactID
			Image.ContactID.SetDbValue(Rs, Image.ContactID.CurrentValue, System.DBNull.Value, True)

			' CompanyID
			Image.CompanyID.SetDbValue(Rs, Image.CompanyID.CurrentValue, System.DBNull.Value, True)
			...
			' sold
			Image.sold.SetDbValue(Rs, (Image.sold.CurrentValue <> "" AndAlso Not IsDBNull(Image.sold.CurrentValue)), System.DBNull.Value, True)
    ...
    user = CurrentUserName()
		...
		' ImageName Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageName", keyvalue, oldvalue, RsSrc("ImageName"))

		' ImageFileName Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageFileName", keyvalue, oldvalue, RsSrc("ImageFileName"))

		' ImageThumbFileName Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageThumbFileName", keyvalue, oldvalue, RsSrc("ImageThumbFileName"))

		' ImageDescription Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageDescription", keyvalue, oldvalue, "<MEMO>")

		' ImageComment Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageComment", keyvalue, oldvalue, "<MEMO>")

		' ImageDate Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "ImageDate", keyvalue, oldvalue, RsSrc("ImageDate"))
		...
		' medium Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "medium", keyvalue, oldvalue, RsSrc("medium"))

		' size Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "size", keyvalue, oldvalue, RsSrc("size"))

		' price Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "price", keyvalue, oldvalue, RsSrc("price"))

		' color Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "color", keyvalue, oldvalue, RsSrc("color"))

		' subject Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "subject", keyvalue, oldvalue, RsSrc("subject"))

		' sold Field
		ew_WriteAuditTrail(filePfx, curDateTime, id, user, action, table, "sold", keyvalue, oldvalue, RsSrc("sold"))
	End Sub
