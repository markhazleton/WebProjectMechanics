...
Partial Class zpage_edit
	...
	Class czPage_edit
		...
		' ASP.NET page object
		Public ReadOnly Property AspNetPage() As zpage_edit
			Get
				Return CType(m_ParentPage, zpage_edit)
			End Get
		End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit") <> "" Then
			...
			If Not ValidateForm() Then
				...
				zPage.EventCancelled = True ' Event cancelled
				LoadRow() ' Restore row
	...
	Function EditRow() As Boolean
		...
		Else
			Try
				...
				' ParentPageID
				zPage.ParentPageID.SetDbValue(Rs, zPage.ParentPageID.CurrentValue, System.DBNull.Value, False)
				...
				' PageTypeID
				zPage.PageTypeID.SetDbValue(Rs, zPage.PageTypeID.CurrentValue, System.DBNull.Value, False)

				' GroupID
				zPage.GroupID.SetDbValue(Rs, zPage.GroupID.CurrentValue, System.DBNull.Value, False)
				...
				' PageOrder
				zPage.PageOrder.SetDbValue(Rs, zPage.PageOrder.CurrentValue, 0, False)

				' CompanyID
				zPage.CompanyID.SetDbValue(Rs, zPage.CompanyID.CurrentValue, System.DBNull.Value, False)
				...
				' ImagesPerRow
				zPage.ImagesPerRow.SetDbValue(Rs, zPage.ImagesPerRow.CurrentValue, System.DBNull.Value, False)

				' RowsPerPage
				zPage.RowsPerPage.SetDbValue(Rs, zPage.RowsPerPage.CurrentValue, System.DBNull.Value, False)
				...
				' VersionNo
				zPage.VersionNo.SetDbValue(Rs, zPage.VersionNo.CurrentValue, System.DBNull.Value, False)
