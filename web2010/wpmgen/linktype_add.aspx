<%@ Page ClassName="linktype_add" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="linktype_add.aspx.vb" Inherits="linktype_add" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
LinkType_add.FormID = "fLinkTypeadd"; // form ID 
...
LinkType_add.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= LinkType.TableCaption %><br /><br />
<a href="<%= LinkType.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(LinkType_add.DebugMsg) %>
