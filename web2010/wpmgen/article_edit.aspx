<%@ Page ClassName="article_edit" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="article_edit.aspx.vb" Inherits="article_edit" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var Article_edit = new ew_Page("Article_edit");
// page properties
Article_edit.PageID = "edit"; // page ID
Article_edit.FormID = "fArticleedit"; // form ID 
var EW_PAGE_ID = Article_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
Article_edit.ValidateForm = function(fobj) {
...
Article_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!
 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
<% If EW_CLIENT_VALIDATE Then %>
Article_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
Article_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
...
<p><span class="aspnetmaker"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= Article.TableCaption %><br /><br />
<a href="<%= Article.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(Article_edit.DebugMsg) %>
<% Article_edit.ShowMessage() %>
<form name="fArticleedit" id="fArticleedit" method="post" onsubmit="this.action=location.pathname;return Article_edit.ValidateForm(this);">
<p />
<input type="hidden" name="a_table" id="a_table" value="Article" />
...
<% Else %>
<% Article.CompanyID.EditAttrs("onchange") = "ew_UpdateOpt('x_zPageID','x_CompanyID',Article_edit.ar_x_zPageID);ew_UpdateOpt('x_userID','x_CompanyID',Article_edit.ar_x_userID);ew_UpdateOpt('x_Author','x_CompanyID',Article_edit.ar_x_Author);" %>
...
<script type="text/javascript">
<!--
Article_edit.ar_x_zPageID = [<%= jswrk %>];
//-->
</script>
<% End If %>
...
<script type="text/javascript">
<!--
Article_edit.ar_x_userID = [<%= jswrk %>];
//-->
</script>
...
<script type="text/javascript">
<!--
Article_edit.ar_x_Author = [<%= jswrk %>];
//-->
</script>
...
<input type="hidden" name="x_ArticleID" id="x_ArticleID" value="<%= ew_HTMLEncode(Article.ArticleID.CurrentValue) %>" />
<p />
<input type="submit" name="btnAction" id="btnAction" value="<%= ew_BtnCaption(Language.Phrase("EditBtn")) %>" />
</form>
<script language="JavaScript" type="text/javascript">
<!--
ew_UpdateOpts([['x_zPageID','x_CompanyID',Article_edit.ar_x_zPageID],['x_userID','x_CompanyID',Article_edit.ar_x_userID],['x_Author','x_CompanyID',Article_edit.ar_x_Author]]);
//-->
</script>
<script type="text/javascript">
<!--
