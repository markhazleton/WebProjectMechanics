...
Partial Class pagerole_list
	...
	Class cPageRole_list
		...
		' ASP.NET page object
		Public ReadOnly Property AspNetPage() As pagerole_list
			Get
				Return CType(m_ParentPage, pagerole_list)
			End Get
		End Property
		...
		Public Sub New(ByRef APage As AspNetMaker8_wpmWebsite)				
			...
			AddUrl = PageRole.AddUrl
			InlineAddUrl = PageUrl & "a=add"
			GridAddUrl = PageUrl & "a=gridadd"
			GridEditUrl = PageUrl & "a=gridedit"
			MultiDeleteUrl = "pagerole_delete.aspx"
			MultiUpdateUrl = "pagerole_update.aspx"
		...
		Public Sub Page_Init()
			...
			If ew_Get("export") <> "" Then
				PageRole.Export = ew_Get("export")
			ElseIf ew_Post("exporttype") <> "" Then
				PageRole.Export = ew_Post("exporttype")
			Else
				PageRole.ExportReturnUrl = ew_CurrentUrl()
			End If
	...
	Public Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Call PageRole.Recordset_SearchValidated()
		...
		ElseIf PageRole.Export = "email" Then
			ExportData()
			ew_End()
		End If
	End Sub
	...
	Sub GetSearchParm(ByRef Fld As Object)
		Dim FldParm As String = Fld.FldVar.Substring(2)
		Fld.AdvancedSearch.SearchValue = PageRole.GetAdvancedSearch("x_" & FldParm)
		Fld.AdvancedSearch.SearchOperator = PageRole.GetAdvancedSearch("z_" & FldParm)
		Fld.AdvancedSearch.SearchCondition = PageRole.GetAdvancedSearch("v_" & FldParm)
		Fld.AdvancedSearch.SearchValue2 = PageRole.GetAdvancedSearch("y_" & FldParm)
		Fld.AdvancedSearch.SearchOperator2 = PageRole.GetAdvancedSearch("w_" & FldParm)
	End Sub
	...
	Sub RestoreSearchParms()
		...
		If ew_Get("x_PageRoleID") <> "" Then bRestore = False
		...
		If bRestore Then
			...
			Call GetSearchParm(PageRole.PageRoleID)
			Call GetSearchParm(PageRole.RoleID)
			Call GetSearchParm(PageRole.zPageID)
			Call GetSearchParm(PageRole.CompanyID)
		End If
	End Sub
	...
	Sub SetupListOptions()
		...
		ListOptions_Load()
		If PageRole.Export <> "" Or PageRole.CurrentAction = "gridadd" Or PageRole.CurrentAction = "gridedit" Then
	...
	Sub RenderRow()
		...
		' Initialize urls
		ViewUrl = PageRole.ViewUrl
		EditUrl = PageRole.EditUrl
		InlineEditUrl = PageRole.InlineEditUrl
		CopyUrl = PageRole.CopyUrl
		InlineCopyUrl = PageRole.InlineCopyUrl
		DeleteUrl = PageRole.DeleteUrl
	...
	Sub ExportData()
		...
		Else
			sOutputStr = ew_ExportHeader(PageRole.Export)

			' Horizontal format, write header
			If sExportStyle <> "v" OrElse PageRole.Export = "csv" Then
				sExportStr = ""
				ew_ExportAddValue(sExportStr, PageRole.PageRoleID.ExportCaption, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.PageRoleID.CellStyles, ""))
				ew_ExportAddValue(sExportStr, PageRole.RoleID.ExportCaption, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.RoleID.CellStyles, ""))
				ew_ExportAddValue(sExportStr, PageRole.zPageID.ExportCaption, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.zPageID.CellStyles, ""))
				ew_ExportAddValue(sExportStr, PageRole.CompanyID.ExportCaption, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.CompanyID.CellStyles, ""))
				sOutputStr &= ew_ExportLine(sExportStr, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.RowStyles, ""))
			End If
		End If
		...
		Do While Rs.Read() AndAlso lRecCnt < lStopRec
			...
			If lRecCnt >= lStartRec Then
				...
				If PageRole.Export = "xml" Then
					oXmlDoc.AddRow()
					oXmlDoc.AddField("PageRoleID", PageRole.PageRoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue)) ' PageRoleID
					oXmlDoc.AddField("RoleID", PageRole.RoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue)) ' RoleID
					oXmlDoc.AddField("zPageID", PageRole.zPageID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue)) ' PageID
					oXmlDoc.AddField("CompanyID", PageRole.CompanyID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue)) ' CompanyID
				Else

					' Vertical format
					If sExportStyle = "v" AndAlso PageRole.Export <> "csv" Then
						sOutputStr &= ew_ExportField(PageRole.PageRoleID.ExportCaption, PageRole.PageRoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.PageRoleID.CellStyles, "")) ' PageRoleID
						sOutputStr &= ew_ExportField(PageRole.RoleID.ExportCaption, PageRole.RoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.RoleID.CellStyles, "")) ' RoleID
						sOutputStr &= ew_ExportField(PageRole.zPageID.ExportCaption, PageRole.zPageID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.zPageID.CellStyles, "")) ' PageID
						sOutputStr &= ew_ExportField(PageRole.CompanyID.ExportCaption, PageRole.CompanyID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.CompanyID.CellStyles, "")) ' CompanyID

					' Horizontal format
					Else
						sExportStr = ""
						ew_ExportAddValue(sExportStr, PageRole.PageRoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.PageRoleID.CellStyles, ""))
						ew_ExportAddValue(sExportStr, PageRole.RoleID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.RoleID.CellStyles, ""))
						ew_ExportAddValue(sExportStr, PageRole.zPageID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.zPageID.CellStyles, ""))
						ew_ExportAddValue(sExportStr, PageRole.CompanyID.ExportValue(PageRole.Export, PageRole.ExportOriginalValue), PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.CompanyID.CellStyles, ""))
						sOutputStr &= ew_ExportLine(sExportStr, PageRole.Export, IIf(EW_EXPORT_CSS_STYLES, PageRole.RowStyles, ""))
					End If
				End If
			End If
		...
		If PageRole.Export = "xml" Then
			oXmlDoc.Output
		Else
			sOutputStr &= ew_ExportFooter(PageRole.Export)
			ew_Write(sOutputStr)
		End If
	End Sub
