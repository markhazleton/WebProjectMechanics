<%@ Page ClassName="sitetemplate_edit" Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="sitetemplate_edit.aspx.vb" Inherits="sitetemplate_edit" CodeFileBaseClass="AspNetMaker8_wpmWebsite" %>
...
SiteTemplate_edit.FormID = "fSiteTemplateedit"; // form ID 
...
SiteTemplate_edit.Form_CustomValidate =  
...
<p><span class="aspnetmaker"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= SiteTemplate.TableCaption %><br /><br />
<a href="<%= SiteTemplate.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></span></p>
<% If EW_DEBUG_ENABLED Then HttpContext.Current.Response.Write(SiteTemplate_edit.DebugMsg) %>
