<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="SiteParameterType_add.aspx.vb" Inherits="SiteParameterType_add" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Add to TABLE: Parameter Type<br /><br />
<a href="<%= SiteParameterType.ReturnUrl %>">Go Back</a></span></p>
<% SiteParameterType_add.ShowMessage() %>
<form name="fSiteParameterTypeadd" id="fSiteParameterTypeadd" method="post">
<p />
...
<p />
<input type="button" name="btnAction" id="btnAction" value=" Save New " onclick="ew_SubmitForm(SiteParameterType_add, this.form);" />
</form>
<script type="text/javascript">
<!--
