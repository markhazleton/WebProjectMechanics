<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="zPage_edit.aspx.vb" Inherits="zPage_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Edit TABLE: Site Location<br /><br />
...
<select id="x_CompanyID" name="x_CompanyID" onchange="ew_UpdateOpt('x_ParentPageID','x_CompanyID',zPage_edit.ar_x_ParentPageID);"<%= zPage.CompanyID.EditAttributes %>>
<%
emptywrk = True
