<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="Article_edit.aspx.vb" Inherits="Article_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
Article_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
...
<p><span class="aspnetmaker">Edit TABLE: Site Article<br /><br />
<a href="<%= Article.ReturnUrl %>">Go Back</a></span></p>
<% Article_edit.ShowMessage() %>
<form name="fArticleedit" id="fArticleedit" method="post">
<p />
...
<select id="x_CompanyID" name="x_CompanyID" onchange="ew_UpdateOpt('x_zPageID','x_CompanyID',Article_edit.ar_x_zPageID);ew_UpdateOpt('x_ContactID','x_CompanyID',Article_edit.ar_x_ContactID);"<%= Article.CompanyID.EditAttributes %>>
<%
emptywrk = True
...
<script type="text/javascript">
<!--
Article_edit.ar_x_ContactID = [<%= jswrk %>];
//-->
</script>
...
<p />
<input type="button" name="btnAction" id="btnAction" value="Save Changes" onclick="ew_SubmitForm(Article_edit, this.form);" />
</form>
<script language="JavaScript">
<!--
ew_UpdateOpts([['x_zPageID','x_CompanyID',Article_edit.ar_x_zPageID],['x_ContactID','x_CompanyID',Article_edit.ar_x_ContactID]]);
//-->
</script>
<script type="text/javascript">
<!--
