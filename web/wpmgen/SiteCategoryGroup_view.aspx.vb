...
Partial Class SiteCategoryGroup_view
	Inherits AspNetMaker7_WPMGen

	' Page object
	Public SiteCategoryGroup_view As cSiteCategoryGroup_view

	'
	' Page Class
	'
	Class cSiteCategoryGroup_view
		...
		Public Sub New(ByRef APage As AspNetMaker7_WPMGen)				
			...
			m_Page = Me	
			m_PageID = "view"
			m_PageObjName = "SiteCategoryGroup_view"
			m_PageObjTypeName = "cSiteCategoryGroup_view"
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			' Get action
			SiteCategoryGroup.CurrentAction = "I" ' Display form
			Select Case SiteCategoryGroup.CurrentAction
				Case "I" ' Get a record to display
					...
					If lTotalRecs <= 0 Then ' No record found
						...
						sReturnUrl = "SiteCategoryGroup_list.aspx"
					...
					Else ' Match key values
						Do While Rs.Read()
							If ew_SameStr(SiteCategoryGroup.SiteCategoryGroupID.CurrentValue, Rs("SiteCategoryGroupID")) Then
								SiteCategoryGroup.StartRecordNumber = lStartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
					...
					If Not bMatchRecord Then
						Message = "No records found" ' Set no record message
						sReturnUrl = "SiteCategoryGroup_list.aspx" ' No matching record, return to list
					Else
			...
			End Select
		Else
			sReturnUrl = "SiteCategoryGroup_list.aspx" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Page_Terminate(sReturnUrl)

		' Render row
		SiteCategoryGroup.RowType = EW_ROWTYPE_VIEW
		RenderRow()
	End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page init
		SiteCategoryGroup_view = New cSiteCategoryGroup_view(Me)		
		SiteCategoryGroup_view.Page_Init()

		' Page main processing
		SiteCategoryGroup_view.Page_Main()
	End Sub
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		If SiteCategoryGroup_view IsNot Nothing Then SiteCategoryGroup_view.Dispose()
	End Sub
End Class
