<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="Contact_edit.aspx.vb" Inherits="Contact_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Edit TABLE: Site Contact<br /><br />
...
<input type="password" name="x_LogonPassword" id="x_LogonPassword" value="<%= Contact.LogonPassword.EditValue %>" size="30" maxlength="50"<%= Contact.LogonPassword.EditAttributes %> />
