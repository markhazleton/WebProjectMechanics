...
Partial Class PageType_delete
	...
	Sub Page_Main()
		...
		For i As Integer = 0 to arRecKeys.GetUpperBound(0)
			...
			sFilter = sFilter & "[PageTypeID]=" & ew_AdjustSql(sKeyFld) & " AND "
    ...
    user = CurrentUserName()
		...
		' PageTypeCD Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "PageTypeCD", keyvalue, RsSrc("PageTypeCD"), newvalue)

		' PageTypeDesc Field
		ew_WriteAuditTrail(filePfx, curDate, curTime, id, user, action, table, "PageTypeDesc", keyvalue, RsSrc("PageTypeDesc"), newvalue)
