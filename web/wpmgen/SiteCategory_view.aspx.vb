...
Partial Class SiteCategory_view
	Inherits AspNetMaker7_WPMGen

	' Page object
	Public SiteCategory_view As cSiteCategory_view

	'
	' Page Class
	'
	Class cSiteCategory_view
		...
		Public Sub New(ByRef APage As AspNetMaker7_WPMGen)				
			...
			m_Page = Me	
			m_PageID = "view"
			m_PageObjName = "SiteCategory_view"
			m_PageObjTypeName = "cSiteCategory_view"
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			' Get action
			SiteCategory.CurrentAction = "I" ' Display form
			Select Case SiteCategory.CurrentAction
				Case "I" ' Get a record to display
					...
					If lTotalRecs <= 0 Then ' No record found
						...
						sReturnUrl = "SiteCategory_list.aspx"
					...
					Else ' Match key values
						Do While Rs.Read()
							If ew_SameStr(SiteCategory.SiteCategoryID.CurrentValue, Rs("SiteCategoryID")) Then
								SiteCategory.StartRecordNumber = lStartRec ' Save record position
								bMatchRecord = True
								Exit Do
							Else
					...
					If Not bMatchRecord Then
						Message = "No records found" ' Set no record message
						sReturnUrl = "SiteCategory_list.aspx" ' No matching record, return to list
					Else
			...
			End Select
		Else
			sReturnUrl = "SiteCategory_list.aspx" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Page_Terminate(sReturnUrl)

		' Render row
		SiteCategory.RowType = EW_ROWTYPE_VIEW
		RenderRow()
	End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page init
		SiteCategory_view = New cSiteCategory_view(Me)		
		SiteCategory_view.Page_Init()

		' Page main processing
		SiteCategory_view.Page_Main()
	End Sub
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		If SiteCategory_view IsNot Nothing Then SiteCategory_view.Dispose()
	End Sub
End Class
