...
Partial Class CompanySiteParameter_preview
	...
	' Page object
	Public CompanySiteParameter_preview As cCompanySiteParameter_preview

	' Page class for preview
	Class cCompanySiteParameter_preview
		...
		Sub Page_Main()
			...
			CompanySiteParameter = New cCompanySiteParameter(Page)
		End Sub
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		' Page main processing
		CompanySiteParameter_preview = New cCompanySiteParameter_preview(Me)
		CompanySiteParameter_preview.Page_Main()
		...
		' Load recordset			
		Rs = CompanySiteParameter.LoadRs(filter)
		nTotalRecs = 0
	...
	Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
		...
		' Dispose page object
		CompanySiteParameter_preview.Dispose()
	End Sub
End Class
