...
Partial Class MasterPage
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		Else
		    Dim myActiveSite As New wpmActiveSite(Session)
            TopBanner.Text = "<div class=""topbanner""><div class=""rightnav""><a href=""/wpm/admin/default.aspx""> Admin Home </a> | <a href=""/""> Back To Site </a> |" & myActiveSite.GetUserOptions & "</div><h1>" & myActiveSite.CompanyName & " - Administration</h1></div>"
		End If		
	End Sub
End Class
