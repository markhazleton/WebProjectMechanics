<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="SiteLink_add.aspx.vb" Inherits="SiteLink_add" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var SiteLink_add = new ew_Page("SiteLink_add");
// page properties
SiteLink_add.PageID = "add"; // page ID
var EW_PAGE_ID = SiteLink_add.PageID; // for backward compatibility
// extend page with ValidateForm function
SiteLink_add.ValidateForm = function(fobj) {
...
SiteLink_add.ValidateRequired = true; // uses JavaScript validation
<% Else %>
SiteLink_add.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
...
<p><span class="aspnetmaker">Add to TABLE: Site Type Parts<br /><br />
<a href="<%= SiteLink.ReturnUrl %>">Go Back</a></span></p>
<% SiteLink_add.ShowMessage() %>
<form name="fSiteLinkadd" id="fSiteLinkadd" method="post">
<p />
...
<select id="x_SiteCategoryTypeID" name="x_SiteCategoryTypeID" onchange="ew_UpdateOpt('x_SiteCategoryID','x_SiteCategoryTypeID',SiteLink_add.ar_x_SiteCategoryID);"<%= SiteLink.SiteCategoryTypeID.EditAttributes %>>
<%
emptywrk = True
...
<script type="text/javascript">
<!--
SiteLink_add.ar_x_SiteCategoryID = [<%= jswrk %>];
//-->
</script>
...
<p />
<input type="button" name="btnAction" id="btnAction" value=" Save New " onclick="ew_SubmitForm(SiteLink_add, this.form);" />
</form>
<script language="JavaScript">
<!--
ew_UpdateOpts([['x_SiteCategoryID','x_SiteCategoryTypeID',SiteLink_add.ar_x_SiteCategoryID]]);
//-->
</script>
<script type="text/javascript">
<!--
