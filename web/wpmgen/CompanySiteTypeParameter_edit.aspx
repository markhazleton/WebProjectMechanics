<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="CompanySiteTypeParameter_edit.aspx.vb" Inherits="CompanySiteTypeParameter_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--
// Create page object
var CompanySiteTypeParameter_edit = new ew_Page("CompanySiteTypeParameter_edit");
// page properties
CompanySiteTypeParameter_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = CompanySiteTypeParameter_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
CompanySiteTypeParameter_edit.ValidateForm = function(fobj) {
...
CompanySiteTypeParameter_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
CompanySiteTypeParameter_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
...
<p><span class="aspnetmaker">Edit TABLE: Site Type Parameter<br /><br />
<a href="<%= CompanySiteTypeParameter.ReturnUrl %>">Go Back</a></span></p>
<% CompanySiteTypeParameter_edit.ShowMessage() %>
<form name="fCompanySiteTypeParameteredit" id="fCompanySiteTypeParameteredit" method="post">
<p />
<input type="hidden" name="a_table" id="a_table" value="CompanySiteTypeParameter" />
...
<% Else %>
<select id="x_SiteCategoryTypeID" name="x_SiteCategoryTypeID" onchange="ew_UpdateOpt('x_SiteCategoryID','x_SiteCategoryTypeID',CompanySiteTypeParameter_edit.ar_x_SiteCategoryID);"<%= CompanySiteTypeParameter.SiteCategoryTypeID.EditAttributes %>>
<%
emptywrk = True
...
<script type="text/javascript">
<!--
CompanySiteTypeParameter_edit.ar_x_SiteCategoryID = [<%= jswrk %>];
//-->
</script>
...
<input type="hidden" name="x_CompanySiteTypeParameterID" id="x_CompanySiteTypeParameterID" value="<%= ew_HTMLEncode(CompanySiteTypeParameter.CompanySiteTypeParameterID.CurrentValue) %>" />
<p />
<input type="button" name="btnAction" id="btnAction" value="Save Changes" onclick="ew_SubmitForm(CompanySiteTypeParameter_edit, this.form);" />
</form>
<script language="JavaScript">
<!--
ew_UpdateOpts([['x_SiteCategoryID','x_SiteCategoryTypeID',CompanySiteTypeParameter_edit.ar_x_SiteCategoryID]]);
//-->
</script>
<script type="text/javascript">
<!--
