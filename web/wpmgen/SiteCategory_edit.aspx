<%@ Page Language="VB" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="SiteCategory_edit.aspx.vb" Inherits="SiteCategory_edit" CodeFileBaseClass="AspNetMaker7_WPMGen" %>
...
<p><span class="aspnetmaker">Edit TABLE: Site Type Location<br /><br />
...
<select id="x_SiteCategoryTypeID" name="x_SiteCategoryTypeID" onchange="ew_UpdateOpt('x_ParentCategoryID','x_SiteCategoryTypeID',SiteCategory_edit.ar_x_ParentCategoryID);"<%= SiteCategory.SiteCategoryTypeID.EditAttributes %>>
<%
emptywrk = True
...
<script type="text/javascript">
<!--
SiteCategory_edit.ar_x_ParentCategoryID = [<%= jswrk %>];
//-->
</script>
...
<!--
ew_UpdateOpts([['x_ParentCategoryID','x_SiteCategoryTypeID',SiteCategory_edit.ar_x_ParentCategoryID]]);
//-->
</script>
<script language="JavaScript" type="text/javascript">
<!--
