...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cLink
		...
		Public Sub RenderListRow()
			...
			DateAdd.ViewValue = ew_FormatDateTime(DateAdd.ViewValue, 6)
			DateAdd.CssStyle = ""
			DateAdd.CssClass = ""
		...
		Public ReadOnly Property ID() As cField
			Get
				If m_ID Is Nothing Then m_ID = New cField("Link", "x_ID", "ID", "[ID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_ID
			End Get
		End Property
		...
		Public ReadOnly Property Title() As cField
			Get
				If m_Title Is Nothing Then m_Title = New cField("Link", "x_Title", "Title", "[Title]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_Title
			End Get
		End Property
		...
		Public ReadOnly Property LinkTypeCD() As cField
			Get
				If m_LinkTypeCD Is Nothing Then m_LinkTypeCD = New cField("Link", "x_LinkTypeCD", "LinkTypeCD", "[LinkTypeCD]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_LinkTypeCD
			End Get
		End Property
		...
		Public ReadOnly Property CategoryID() As cField
			Get
				If m_CategoryID Is Nothing Then m_CategoryID = New cField("Link", "x_CategoryID", "CategoryID", "[CategoryID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_CategoryID
			End Get
		End Property
		...
		Public ReadOnly Property CompanyID() As cField
			Get
				If m_CompanyID Is Nothing Then m_CompanyID = New cField("Link", "x_CompanyID", "CompanyID", "[CompanyID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_CompanyID
			End Get
		End Property
		...
		Public ReadOnly Property SiteCategoryGroupID() As cField
			Get
				If m_SiteCategoryGroupID Is Nothing Then m_SiteCategoryGroupID = New cField("Link", "x_SiteCategoryGroupID", "SiteCategoryGroupID", "[SiteCategoryGroupID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property zPageID() As cField
			Get
				If m_zPageID Is Nothing Then m_zPageID = New cField("Link", "x_zPageID", "PageID", "[PageID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_zPageID
			End Get
		End Property
		...
		Public ReadOnly Property Views() As cField
			Get
				If m_Views Is Nothing Then m_Views = New cField("Link", "x_Views", "Views", "[Views]", 11, OleDbType.Boolean, EW_DATATYPE_BOOLEAN,  0)
				Return m_Views
			End Get
		End Property
		...
		Public ReadOnly Property Description() As cField
			Get
				If m_Description Is Nothing Then m_Description = New cField("Link", "x_Description", "Description", "[Description]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
		...
		Public ReadOnly Property URL() As cField
			Get
				If m_URL Is Nothing Then m_URL = New cField("Link", "x_URL", "URL", "[URL]", 203, OleDbType.LongVarWChar, EW_DATATYPE_MEMO,  0)
				Return m_URL
			End Get
		End Property
		...
		Public ReadOnly Property Ranks() As cField
			Get
				If m_Ranks Is Nothing Then m_Ranks = New cField("Link", "x_Ranks", "Ranks", "[Ranks]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_Ranks
			End Get
		End Property
		...
		Public ReadOnly Property UserID() As cField
			Get
				If m_UserID Is Nothing Then m_UserID = New cField("Link", "x_UserID", "UserID", "[UserID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
				Return m_UserID
			End Get
		End Property
		...
		Public ReadOnly Property ASIN() As cField
			Get
				If m_ASIN Is Nothing Then m_ASIN = New cField("Link", "x_ASIN", "ASIN", "[ASIN]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_ASIN
			End Get
		End Property
		...
		Public ReadOnly Property UserName() As cField
			Get
				If m_UserName Is Nothing Then m_UserName = New cField("Link", "x_UserName", "UserName", "[UserName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
				Return m_UserName
			End Get
		End Property
		...
		Public ReadOnly Property DateAdd() As cField
			Get
				If m_DateAdd Is Nothing Then m_DateAdd = New cField("Link", "x_DateAdd", "DateAdd", "[DateAdd]", 135, OleDbType.DBTimeStamp, EW_DATATYPE_DATE,  6)
				Return m_DateAdd
			End Get
		End Property
