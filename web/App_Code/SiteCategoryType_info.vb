...
Public Partial Class AspNetMaker7_WPMGen
	...
	Class cSiteCategoryType
		...
		Public Sub RenderListRow()
			...
			If ew_NotEmpty(DefaultSiteCategoryID.CurrentValue) Then
				sSqlWrk = "SELECT [CategoryName], [SiteCategoryTypeID] FROM [SiteCategory] WHERE [SiteCategoryID] = " & ew_AdjustSql(DefaultSiteCategoryID.CurrentValue) & ""
				sSqlWrk = sSqlWrk & " ORDER BY [SiteCategoryTypeID] Asc"
				RsWrk = Conn.GetTempDataReader(sSqlWrk)
				If RsWrk.Read() Then
					DefaultSiteCategoryID.ViewValue = RsWrk("CategoryName")
					DefaultSiteCategoryID.ViewValue = DefaultSiteCategoryID.ViewValue & ew_ValueSeparator(0) & RsWrk("SiteCategoryTypeID")
				Else
					DefaultSiteCategoryID.ViewValue = DefaultSiteCategoryID.CurrentValue
				End If
				Conn.CloseTempDataReader()
			Else
				DefaultSiteCategoryID.ViewValue = System.DBNull.Value
			End If
		...
		Public ReadOnly Property SiteCategoryTypeID() As cField
			Get
				If m_SiteCategoryTypeID Is Nothing Then m_SiteCategoryTypeID = New cField("SiteCategoryType", "x_SiteCategoryTypeID", "SiteCategoryTypeID", "[SiteCategoryTypeID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
		...
		Public ReadOnly Property SiteCategoryTypeNM() As cField
			Get
				If m_SiteCategoryTypeNM Is Nothing Then m_SiteCategoryTypeNM = New cField("SiteCategoryType", "x_SiteCategoryTypeNM", "SiteCategoryTypeNM", "[SiteCategoryTypeNM]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryTypeDS() As cField
			Get
				If m_SiteCategoryTypeDS Is Nothing Then m_SiteCategoryTypeDS = New cField("SiteCategoryType", "x_SiteCategoryTypeDS", "SiteCategoryTypeDS", "[SiteCategoryTypeDS]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryComment() As cField
			Get
				If m_SiteCategoryComment Is Nothing Then m_SiteCategoryComment = New cField("SiteCategoryType", "x_SiteCategoryComment", "SiteCategoryComment", "[SiteCategoryComment]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryFileName() As cField
			Get
				If m_SiteCategoryFileName Is Nothing Then m_SiteCategoryFileName = New cField("SiteCategoryType", "x_SiteCategoryFileName", "SiteCategoryFileName", "[SiteCategoryFileName]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property SiteCategoryTransferURL() As cField
			Get
				If m_SiteCategoryTransferURL Is Nothing Then m_SiteCategoryTransferURL = New cField("SiteCategoryType", "x_SiteCategoryTransferURL", "SiteCategoryTransferURL", "[SiteCategoryTransferURL]", 202, OleDbType.VarWChar, EW_DATATYPE_STRING,  0)
		...
		Public ReadOnly Property DefaultSiteCategoryID() As cField
			Get
				If m_DefaultSiteCategoryID Is Nothing Then m_DefaultSiteCategoryID = New cField("SiteCategoryType", "x_DefaultSiteCategoryID", "DefaultSiteCategoryID", "[DefaultSiteCategoryID]", 3, OleDbType.Integer, EW_DATATYPE_NUMBER,  0)
