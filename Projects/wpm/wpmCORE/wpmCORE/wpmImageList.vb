...
Public Class wpmPageImageList
    ...
    Public Sub New(ByRef ActiveSite As wpmActiveSite)
        ...
        For Each myrow As DataRow In mydt.Rows
            ...
            Me.CatalogBasePageURL = wpmUTIL.FixInvalidCharacters(myrow.Item("PageName").ToString & App.Config.DefaultExtension)
            Me.CatalogPageName = wpmUTIL.GetDBString(myrow.Item("PageName"))
            Me.PageFileName = wpmUTIL.GetDBString(myrow.Item("PageFileName"))
            myImage.ImageURL = wpmUTIL.FixInvalidCharacters(myrow.Item("PageName").ToString & "-" & myrow.Item("ImageName").ToString & App.Config.DefaultExtension)
            myImage.ImageID = wpmUTIL.GetDBString(myrow.Item("ImageID"))
            myImage.VersionNumber = wpmUTIL.GetDBInteger(myrow.Item("VersionNo"))
            myImage.Title = wpmUTIL.GetDBString(myrow.Item("Title"))
            myImage.ImageName = wpmUTIL.GetDBString(myrow.Item("ImageName"))
    ...
    Public Function ProcessPageRequest(ByVal PageNumber As String, ByVal ImageID As String) As String
        ...
        If (ImageID = "") Then
            ...
            If myStringBuilder.ToString.IndexOf("~~pan-lightbox~~") > 0 Then
                ...
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/slider/pan.js"), myContents)
            ...
            If myStringBuilder.ToString.IndexOf("~~slider~~") > 0 Then
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/slider/slider.js"), myContents)
            ...
            If myStringBuilder.ToString.IndexOf("~~lightbox~~") > 0 Then
                ...
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/lightbox/ADDToHTMLHead.txt"), myContents)
            ...
            If myStringBuilder.ToString.IndexOf("~~thumbnail~~") > 0 Then
                ...
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/cmotion/AddToHTMLHead.txt"), myContents)
                ActiveSite.AddHTMLHead = myContents.ToString
            End If
            ...
            If myStringBuilder.ToString.IndexOf("~~cmotionlb~~") > 0 Then
                ...
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/cmotion/AddToHTMLHeadLB.txt"), myContents)
                ActiveSite.AddHTMLHead = myContents.ToString
            End If
            If myStringBuilder.ToString.IndexOf("photoalbum") > 0 Then
                myStringBuilder.Replace("~~photoalbum~~", BuildPhotoAlbumPage())
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/photoalbum/ADDToHTMLHead.txt"), myContents)
                ActiveSite.AddHTMLHead = myContents.ToString
            End If
            If myStringBuilder.ToString.IndexOf("~~drill-in~~") > 0 Then
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/slider/drill-in.js"), myContents)
            ...
            If myStringBuilder.ToString.IndexOf("~~fade~~") > 0 Then
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/slider/fadeimages.html"), myContents)
            ...
            If myStringBuilder.ToString.IndexOf("~~yui-carousel~~") > 0 Then
                ...
                Dim myContents As New StringBuilder
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath("/wpm/catalog/yui-carousel/ADDToHTMLHead.txt"), myContents)
                ActiveSite.AddHTMLHead = myContents.ToString
            ...
            If wpmUser.IsAdmin() Then
                myStringBuilder.Append("<br /><strong><a href=""/wpm/admin/browse_images.aspx?SubFolder=" & Me.CatalogPageName & """>Browse Images</a></strong><br />")
            End If
        Else
            ' Code for Detail Image
            If Me.PageFileName = String.Empty Then
                wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath(ActiveSite.SiteGallery & "/catalog_template.html"), myStringBuilder)
            Else
                If Not wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath(ActiveSite.SiteGallery & "/" & Me.PageFileName & "_template.html"), myStringBuilder) Then
                    wpmFileIO.ReadTextFile(HttpContext.Current.Server.MapPath(ActiveSite.SiteGallery & "/catalog_template.html"), myStringBuilder)
                End If
            End If
    ...
    Private Function GetImageLocation(ByRef myImage As wpmImage) As String
        Return wpmUTIL.FixInvalidCharacters(Me.ActiveSite.GetCurrentPageName & "-" & myImage.ImageName & App.Config.DefaultExtension)
    ...
    Public Function FixFolders(ByVal sPageID As String) As Boolean
        ...
        For Each myImage As wpmImage In Me
            If ActiveSite.CurrentPageID = sPageID Then
                ...
                wpmFileIO.CreateFolder(sNewPagePath)
                ' Create a Folder for Image/Page and move this image file to the folder
                sNewImagePath = sNewPagePath
                wpmFileIO.CreateFolder(sNewImagePath)
                wpmFileIO.MoveFile(HttpContext.Current.Server.MapPath(ActiveSite.SiteGallery & _
    ...
    Private Function BuildImageAdmin(ByVal ImageID As String, ByVal PageID As String) As String
        If wpmUser.IsEditor() Then
            Return "<hr><a href=""" & App.Config.wpmWebHome() & "admin/ImageEdit.aspx?a=" & ImageID & "&c=" & PageID & """>Edit This Image</a> - " & _
                   "<a href=""" & App.Config.wpmWebHome() & "admin/ImageEdit.aspx?a=" & ImageID & "&c=" & PageID & """>Delete</a><br>"
        Else
            Return ""
        End If
    End Function
