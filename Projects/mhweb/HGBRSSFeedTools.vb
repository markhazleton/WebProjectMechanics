...
#Region "constructors"
        ''' <summary>
        ''' Initializes a new instance of the HGBRSS class. You must enter a feed url as a string.
        ''' </summary>
...
#Region "Internal methodes and properties"
        Public Function GetOneItem(ByVal itemnumber As Integer) As RSSItem
            Dim newrssitem As New RSSItem
            newrssitem = CType(_items(itemnumber), RSSItem)
            Return newrssitem
        End Function
