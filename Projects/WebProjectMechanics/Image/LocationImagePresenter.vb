...
Public Class LocationImagePresenter
    ...
    Public Sub SetImageValues(ByRef ReqImageID As String)
        ...
        yourLocationImage.Medium = myLocationImage.Medium
        yourLocationImage.Size = myLocationImage.Size
        yourLocationImage.Price = myLocationImage.Price
        yourLocationImage.Color = myLocationImage.Color
        yourLocationImage.Subject = myLocationImage.Subject
        yourLocationImage.Sold = myLocationImage.Sold
    End Sub
    Private Sub GetImageValues(ByRef ReqImageID As String)
        ...
        myLocationImage.Medium = yourLocationImage.Medium
        myLocationImage.Size = yourLocationImage.Size
        myLocationImage.Price = yourLocationImage.Price
        myLocationImage.Color = yourLocationImage.Color
        myLocationImage.Subject = yourLocationImage.Subject
        myLocationImage.Sold = yourLocationImage.Sold
