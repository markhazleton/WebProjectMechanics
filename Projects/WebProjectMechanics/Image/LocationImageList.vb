...
Public Class LocationImageList
    ...
    Public Function ProcessPageRequest(ByVal ImageID As Integer, ByRef myArticle As Article) As String
        Dim sRightContent As String = ("")
        Dim myStringBuilder As StringBuilder = New StringBuilder("")
        If (ImageID < 1) Then
            ' code for thumnail page
            myStringBuilder.Append(GetImageTextMerge(myArticle.ArticleBody, True, sRightContent, wpm_SiteGallery))
    ...
    Private Function ReplaceImageTags(ByRef myImage As LocationImage, ByRef sbCatalog As StringBuilder) As Boolean
        ...
        sbCatalog.Replace(STR_ImgMedium, myImage.Medium)
        sbCatalog.Replace(STR_ImgSize, myImage.Size)
    ...
    Private Shared Function BuildImageAdmin(ByVal ImageID As String, ByVal PageID As String) As String
        If wpm_IsEditor() Then
            Return String.Format("<br/><a href=""/admin/maint/default.aspx?type=Image&ImageID={0}"">Edit This Image</a><br/>", ImageID)
        Else
            Return String.Empty
        End If
    End Function
