...
Public Class wpmPartList
    ...
    Public Function PopulateSiteCategoryLinkRows(ByVal CompanyID As String, ByVal SiteCategoryTypeID As String) As Boolean
        ...
        Catch ex As Exception
            bReturn = False
            wpmLogging.AuditLog("ERROR ON wpmSiteLinkRows.PopulateSiteLinkRows-Cateogry()", ex.ToString)
        End Try
        Return bReturn
    End Function
    Public Function PopulateSiteLinkRows(ByVal CompanyID As String) As Boolean
        ...
        Catch innerex As Exception
            bReturn = False
            wpmLogging.AuditLog("ERROR ON wpmSiteLinkRows.PopulateSiteLinkRows()", innerex.ToString)
        End Try
        Return bReturn
    End Function
    '
