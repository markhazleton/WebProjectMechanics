...
Public NotInheritable Class wpmMembershipProvider
    Inherits MembershipProvider

#Region "Class Variables"

    Private _newPasswordLength As Integer = 8
...
#Region "Implemented Abstract Methods from MembershipProvider"
    ...
    ByVal newPwd As String) As Boolean
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                ...
                wpmLogging.MembershipProviderError("wpmMembershipProvider.ChangePassword", e.Message)
                Return False
            Finally
    ...
    ByVal newPwdAnswer As String) As Boolean
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.ChangePasswordQuestionAndAnswer", e.Message)
                Return False
            Finally
                _sqlConnection.Close()
            End Try
    ...
    As MembershipUser
        ...
        If _membershipUser Is Nothing Then
            ...
            Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
                ...
                Catch e As SqlException
                    'Add exception handling here.
                    wpmLogging.MembershipProviderError("wpmMembershipProvider.CreateUser", e.Message)
    ...
    ByVal deleteAllRelatedData As Boolean _
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.DeleteUser", e.Message)
            Finally
                _sqlConnection.Close()
            End Try
        End Using
    ...
    As MembershipUserCollection
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.GetAllUsers", e.Message)
            Finally
    ...
    Public Overrides Function GetNumberOfUsersOnline() As Integer
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.GetNumberOfUsersOnline", e.Message)
            Finally
                _sqlConnection.Close()
            End Try
            Return numOnline
    ...
    As String
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Try
                _sqlConnection.Open()
                _sqlDataReader = _sqlCommand.ExecuteReader(CommandBehavior.SingleRow + CommandBehavior.CloseConnection)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.GetPassword", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
            End Try
    ...
    As MembershipUser
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.GetUser", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
            End Try
    ...
    As Boolean
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.UnlockUser", e.Message)
                Return False
            Finally
                _sqlConnection.Close()
            End Try
    ...
    Public Overrides Function GetUserNameByEmail(ByVal email As String) As String
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Try
                _sqlConnection.Open()
                _username = _sqlCommand.ExecuteScalar()
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.GetUserNameByEmail", e.Message)
            Finally
                _sqlConnection.Close()
            End Try
    ...
    As String
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.ResetPassword", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
            End Try
    ...
    Public Overrides Sub UpdateUser(ByVal _membershipUser As MembershipUser)
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.UpdateUser", e.Message)
            Finally
                _sqlConnection.Close()
            End Try
        End Using
    ...
    As Boolean
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.ValidateUser", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
    ...
    As MembershipUserCollection
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.FindUsersByName", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
            End Try
    ...
    As MembershipUserCollection
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch e As SqlException
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.FindUsersByEmail", e.Message)
            Finally
                If Not _sqlDataReader Is Nothing Then _sqlDataReader.Close()
            End Try
            totalRecords = _counter
    ...
    Private Sub UpdateFailureCount(ByVal username As String, ByVal failureType As FailureType)
        ...
        Using _sqlConnection As SqlConnection = New SqlConnection(_sqlConnectionString)
            ...
            Catch ex As Exception
                'Add exception handling here.
                wpmLogging.MembershipProviderError("wpmMembershipProvider.UpdateFailureCount", ex.InnerException.ToString)
