...
Public Module App
    ...
    Private Const wpm_STR_CurrentSiteCategoryTypeID As String = "wpm_CurrentSiteCategoryTypeID"
    ...
    Public Function wpm_GetSessionDebug() As String
        ...
        mysb.Append("<br/><br/><table border=""1"">")
    ...
    Public Property wpm_CurrentSiteName As String
        ...
        End Set
    End Property
    Public Property wpm_CurrentSiteCategoryTypeID As String
        Get
            Return CStr(HttpContext.Current.Session.Item(wpm_STR_CurrentSiteCategoryTypeID))
        End Get
        Set(ByVal value As String)
            HttpContext.Current.Session.Item(wpm_STR_CurrentSiteCategoryTypeID) = value
        End Set
    End Property
