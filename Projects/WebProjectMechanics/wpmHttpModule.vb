...
Public Class wpmHttpModule
    ...
    Private Sub Application_BeginRequest(ByVal source As Object, _
        ...
        If url.Contains("://www.") AndAlso wpmApp.Config.RemoveWWW Then
            wpmLogging.AccessLog("Remove WWW", url.ToString())
            RemoveWww(context)
        End If
        If Not url.Contains("://www.") AndAlso Not wpmApp.Config.RemoveWWW Then
            wpmLogging.AccessLog("Add WWW", url.ToString())
            AddWww(context)
        End If
    End Sub
