...
Public Class wpmUtil
    Public Shared Function CheckForMatch(ByVal StringOne As String, ByVal StringTwo As String) As Boolean
        ...
        Else
            ...
            StringOne = Replace(StringOne, "-", "")
            StringOne = Replace(StringOne, " ", "")
            StringOne = Replace(StringOne, wpmApp.Config.DefaultExtension, "")
            ...
            StringTwo = Replace(StringTwo, "&amp;", "&")
            StringTwo = Replace(StringTwo, "-", "")
            StringTwo = Replace(StringTwo, wpmApp.Config.DefaultExtension, "")
    ...
    Public Shared Function GetDBInteger(ByRef dbObject As Object) As Integer
        ...
        End If
    End Function
    Public Shared Function GetDBInteger(ByRef dbObject As Object, ByVal DefaultValue As Integer) As Integer
        If IsDBNull(dbObject) Then
            Return DefaultValue
        ElseIf dbObject Is Nothing Then
            Return DefaultValue
    ...
    Public Shared Function IsBreak(ByVal hInput As Object, ByVal hBreakPoint As Double) As Boolean
        ...
        End If
    End Function
    Public Shared Function FormatGraphicLink(ByVal LinkURL As String, ByVal sImage As String) As String
        FormatGraphicLink = String.Format("<a href=""{0}""><img alt=""{1}"" border=0 src=""/wpm/images/{1}.gif""  /></a>", _
                                LinkURL, _
                                sImage)
    End Function
    ...
    Public Shared Function FormatPageNameLink(ByVal sPageName As String) As String
        ...
        Else
            sReturn = String.Format("<a href=""{0}"">{1}</a>", FormatPageNameURL(sPageName), sPageName)
        End If
    ...
    Public Shared Function FormatPageNameURL(ByVal sPageName As String) As String
        If Trim(sPageName) = "" Then
            FormatPageNameURL = "/"
        Else
            FormatPageNameURL = String.Format("/{0}{1}", wpmUtil.FixInvalidCharacters(sPageName), wpmApp.Config.DefaultExtension())
        End If
    End Function
    ...
    Public Shared Function OrdinalSuffix() As String
        Dim lLngDay As Integer = Microsoft.VisualBasic.Day(Now)
    ...
    Public Shared Function Build301Redirect(ByVal sNewURL As String) As Boolean
        ...
        Return True
    End Function
    Protected Shared Function HexStringToColor(ByVal hex As String) As System.Drawing.Color
        hex = hex.Replace("#", "")
