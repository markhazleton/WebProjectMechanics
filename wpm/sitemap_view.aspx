<%@ Page Language="VB" MasterPageFile="~/wpm/wpm.master" Explicit="true" EnableSessionState="True" Debug="true" Strict="false" Trace="true" Title="Test Master" %>
<%@ Import Namespace="System.IO" %>
<%@ Import Namespace="System.Xml" %>
<%@ Import Namespace="System.Xml.Xsl" %>
<script runat="server" type="text/VB">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        Label1.Text = getSiteMap("http://" & Request.ServerVariables("SERVER_NAME") & "/wpm/sitemap.aspx")
    End Sub
    Function getSiteMap(ByVal sURL As String) As String
        ...
        myStringBuilder.Append(vbCrLf & "<p><em>Retrieved at: " & system.datetime.now() & "</em> from " & sURL & "</p>" & vbCrLf)
